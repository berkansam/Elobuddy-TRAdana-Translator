...
using EloBuddy;
using LaughAtYou.SkillshotTypes;
using LaughAtYou.SkillshotTypes.SpecialTypes;

namespace LaughAtYou
{
    internal static class SkillshotDatabase
    {
        public static List<EvadeSkillshot> Database = new List<EvadeSkillshot>();
        ...
        static SkillshotDatabase()
        {
            ...
            //Database.Add( new LinearMissileSkillshot
            //{
            //    SpellData = new SpellData
            //    {
            //        ChampionName = "Ashe",
            ...
            */
            ...
            //    }
            //});
            //Database.Add( new LinearMissileSkillshot //Unknown:
            //{
            //    SpellData = new SpellData
            //    {
            //        ChampionName = "Viktor",
        ...
        public static SpellData GetByName(string spellName)
        {
            ...
            foreach (var spellData in Database)
            {
                if (spellData.SpellData.SpellName.ToLower() == spellName)
                {
        ...
        public static SpellData GetByMissileName(string missileSpellName)
        {
            ...
            foreach (var spellData in Database)
            {
                if (spellData.SpellData.MissileSpellName != null && spellData.SpellData.MissileSpellName.ToLower() == missileSpellName)
                {
                    return spellData.SpellData;
                }
            }
        ...
        public static SpellData GetBySpeed(string ChampionName, int speed)
        {
            foreach (var spellData in Database)
            {
                if (spellData.SpellData.ChampionName == ChampionName && spellData.SpellData.MissileSpeed == speed)
                {
                    return spellData.SpellData;
                }
            }
