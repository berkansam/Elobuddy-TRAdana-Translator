...
namespace Morgana
{
    internal class Program
    {
        ...
        private static void OnLoaded(EventArgs args)
        {
            ...
            MorgMenu.AddLabel("Bloodimir Morgana v2.0.2.3- çeviri tradana");

            ComboMenu = MorgMenu.AddSubMenu("Kombo", "sbtw");
            ...
            AutoCastMenu.Add("qd", new CheckBox("Otomatik Q Dashing"));
            AutoCastMenu.Add("qi", new CheckBox("Otomatik Q İmkansızı Başar"));
            AutoCastMenu.Add("ar", new CheckBox("Otomatik R"));
            AutoCastMenu.Add("rslider", new Slider("R için gerekli kişi sayısı", 2, 0, 5));

            QMenu = MorgMenu.AddSubMenu("Q Ayarları", "qsettings");
            QMenu.AddGroupLabel("Q Ayarları");
            QMenu.AddSeparator();
            QMenu.Add("qmin", new Slider("Min Menzil", 165, 0, (int)Q.Range));
            QMenu.Add("qmax", new Slider("Max Menzil", (int)Q.Range, 0, (int)Q.Range));
            QMenu.AddSeparator();
            ...
            QMenu.AddSeparator();
            QMenu.Add("mediumpred", new CheckBox("Orta Tutma Oranı Prediction'u", false));
            QMenu.AddSeparator();
            QMenu.Add("intq", new CheckBox("Q to Interrupt"));

            SkinMenu = MorgMenu.AddSubMenu("Skin Değiştirici", "skin");
            ...
            MiscMenu = MorgMenu.AddSubMenu("Ek", "misc");
            ...
            MiscMenu.Add("talisman", new CheckBox("Uluların Tılsımı Kullan"));
            MiscMenu.Add("randuin", new CheckBox("Randuin Alameti Kullan"));
            MiscMenu.Add("szhonya", new CheckBox("Basit Zhonya"));
            MiscMenu.Add("lvlup", new CheckBox("Otomatik Büyü Arttırma", false));
            MiscMenu.AddSeparator();
            MiscMenu.Add("EAllies", new CheckBox("Otomatik E"));
            foreach (var obj in ObjectManager.Get<AIHeroClient>().Where(obj => obj.Team == Me.Team))
            {
            ...
            DrawMenu = MorgMenu.AddSubMenu("Gösterge", "drawings");
