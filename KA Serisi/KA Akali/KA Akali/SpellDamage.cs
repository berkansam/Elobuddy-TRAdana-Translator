        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    ...
                    damage = new float[] { 35, 55, 75, 95, 115 }[spellLevel] + 0.4f * Player.Instance.FlatMagicDamageMod;
                    break;
                ...
                case SpellSlot.E:
                    ...
                    damage = new float[] { 30, 55, 80, 105, 130 }[spellLevel] + 0.4f * Player.Instance.FlatMagicDamageMod + 0.6f * Player.Instance.FlatPhysicalDamageMod;
                    break;

                case SpellSlot.R:

                    damage = new float[] { 100, 175, 250 }[spellLevel] + 0.5f * Player.Instance.FlatMagicDamageMod;
                    break;
            }
