...
namespace AutoSpellUp
{
    ...
    internal class Program
    {
        ...
        {
            Menu = MainMenu.AddMenu("Otomatik Level Yükseltme", "AutoLevelUp");

            Menu.AddGroupLabel("Dakote ve KarmaPanda'nýn Otomatik Level Yükseltmesi");
            Menu.AddLabel(Player.ChampionName + " Yüklendi Yapým Dakota,Karmapanda çeviri Tradana iyi oyunlar");
            Menu.Add("delay", new Slider("Max Rastgele Gecikme Süresi", 1000, 0, 10000));
