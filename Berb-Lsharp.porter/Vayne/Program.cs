...
namespace Vayne
{
    public static class Program
    {
        ...
        private static void InitMenu()
        {
            ...
            ComboMenu.AddSeparator();
            ComboMenu.AddLabel("1 : Asla | 2 : E-Hazır değilse | 3 : Herzaman");
            ComboMenu.Add("qantigc", new Slider("AntigapcloserQ:", 3, 1, 3)); // UseQAntiGapcloserStringList
            ComboMenu.AddSeparator();
            ComboMenu.Add("dontaa", new KeyBind("R açınca düz vuruş yapma(tuş)", false, KeyBind.BindTypes.PressToggle, 'T'));
            ComboMenu.Add("dontaaslider", new CheckBox("^ Şu kadar düşman varsa düz vuruş yapma?"));
            ...
            QSettings.Add("noqenemies", new CheckBox("Düşmanın içine Q atma", true)); // noqenemies
            QSettings.Add("smartq", new CheckBox("Akıllı Q", true)); // noqenemiesold
            QSettings.Add("2wstacks", new CheckBox("Qyu sadece 2W stack varsa kullan", false)); // 2wstacks
            QSettings.AddSeparator();
            QSettings.AddGroupLabel("Sharpshooter Q Ayarları");
            QSettings.AddLabel("YOU HAVE TO HAVE OPTION 4 SELECTED TO USE THIS");
            QSettings.Add("antiMelee", new CheckBox("Yakın dövüş şampiyonlarını Q ile öldür", true)); // antiMelee
            QSettings.AddSeparator();
            QSettings.AddGroupLabel("Synx Auto Carry Q Ayarları");
            ...
            QSettings.AddSeparator();
            QSettings.AddGroupLabel("Cursor/Kite Melee/Kurisu Q Ayarları");
            QSettings.AddLabel("YOU HAVE TO HAVE OPTION 6, 7 OR 8 SELECTED TO USE THIS");
            QSettings.Add("Cdynamicqsafety", new CheckBox("Dinamik Güvenli Q", true));
            QSettings.Add("Csmartq", new CheckBox("Akıllı Q", true));
            QSettings.Add("Cnoqenemies", new CheckBox("Düşmanın içine Q atma", true));
            QSettings.Add("Cnoqenemiesold", new CheckBox("Düşmanın içine Q atma,eski", true));
            QSettings.Add("Cqspam", new CheckBox("Görmezden gelme AKA Spam Q", true));
            QSettings.AddSeparator();
            ...
            CondemnSettings.AddSeparator();
            CondemnSettings.Add("onlyCondemnTarget", new CheckBox("Sadece sabitleyecekse", false)); // UseEInterruptBool
            CondemnSettings.Add("useeinterrupt", new CheckBox("Interrupt E")); // UseEInterruptBool
            CondemnSettings.Add("useeantigapcloser", new CheckBox("AntiGapcloser E")); // UseEAntiGapcloserBool
            CondemnSettings.AddSeparator();
            CondemnSettings.Add("epushdist", new Slider("E İtme mesafesi: ", 425, 300, 475)); // EPushDistanceSlider
            CondemnSettings.AddSeparator();
            CondemnSettings.Add("ehitchance", new Slider("Condemn İsabet Oranı", 75, 0, 100)); // EHitchanceSlider
            CondemnSettings.AddSeparator();

            ESettings = Menu.AddSubMenu("E Settings", "esettings");
            ESettings.AddGroupLabel("SAC Condemn Ayarları");
            ...
            ESettings.AddSeparator();
            ESettings.AddGroupLabel("OKTW Condemn Ayarları");
            ...
            FarmSettings.Add("useqfarm", new CheckBox("Farmda Q kullan")); // UseQFarm
            FarmSettings.Add("useejgfarm", new CheckBox("Ormanda E KUllan")); // UseEJungleFarm
            FarmSettings.AddSeparator();

            ExtraMenu = Menu.AddSubMenu("Extra Settings", "extra");
            ExtraMenu.AddGroupLabel("Extra Ayarları");
            ExtraMenu.AddSeparator();
            ExtraMenu.Add("usee3rdwproc", new CheckBox("3üncü W den sonra E Kullan: ", false)); // UseEAs3rdWProcBool
            ExtraMenu.Add("useqonenemiesnotcs", new CheckBox("Use Q Bonus On ENEMY not CS", false)); // UseQBonusOnEnemiesNotCS
            ExtraMenu.Add("useqonlyon2stackedenemies", new CheckBox("2W stack varsa Q kullan", false)); // UseQOnlyAt2WStacksBool
            ExtraMenu.AddSeparator();

            ItemMenu = Menu.AddSubMenu("Activator", "item");
            ItemMenu.Add("useHeal", new CheckBox("Heal Kullan?"));
            ItemMenu.Add("lowerHeal", new Slider("Canım şundan az :", 15, 0, 100));
            ItemMenu.AddSeparator();
            ItemMenu.Add("useBotrk", new CheckBox("Kullan Mahvolmuş KıLICI?"));
            ItemMenu.Add("useCutlass", new CheckBox("Kullan Bilgewater Palası?"));
            ItemMenu.Add("useGhostBlade", new CheckBox("Kullan GhostBlade?"));
            ItemMenu.AddSeparator();
            ItemMenu.Add("Clean", new CheckBox("Ootmatik QSS/Mercurial/Dervish/Mikaels/Cleanse"));
            ItemMenu.AddSeparator();
            ItemMenu.Add("CSSDelay", new Slider("QSS Gecikmesi", 0, 0, 1000)); // CSSDelay
            ItemMenu.AddSeparator();
            ...
            ItemMenu.AddSeparator();
            ItemMenu.Add("cleanHP", new Slider("Sadece canım şunun altındaysa (101 : Sonsuza dek :))", 95, 0, 101));  // cleanHP
            ItemMenu.AddSeparator();
            ItemMenu.Add("CleanSpells", new CheckBox("Tehlike temizle (Zed R Örneği.)"));
            ItemMenu.Add("Stun", new CheckBox("Sabitleme"));
            ItemMenu.Add("Snare", new CheckBox("Yavaşatlama"));
            ItemMenu.Add("Charm", new CheckBox("Charm"));
            ItemMenu.Add("Fear", new CheckBox("Korku"));
            ItemMenu.Add("Suppression", new CheckBox("Zorlama"));
            ItemMenu.Add("Taunt", new CheckBox("Alay Etme"));
            ItemMenu.Add("Blind", new CheckBox("Kör etme"));
            ItemMenu.AddSeparator();
            ...
            DrawingMenu.Add("drawCurrentLogic", new CheckBox("Q/E akım mantığı")); // DrawWStacksBool
            DrawingMenu.AddSeparator();
        }
