...
namespace LeeSin
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.Add("ElLeeSin.Combo.Q", new CheckBox("Kullan Q"));
            Menu.Add("ElLeeSin.Combo.Q2", new CheckBox("Kullan Q2"));
            Menu.Add("ElLeeSin.Combo.W2", new CheckBox("Kullan W"));
            Menu.Add("ElLeeSin.Combo.E", new CheckBox("Kullan E"));
            Menu.Add("ElLeeSin.Combo.R", new CheckBox("Kullan R"));
            Menu.Add("ElLeeSin.Combo.KS.R", new CheckBox("R KS için kullan"));

            Menu.Add("ElLeeSin.Combo.New", new CheckBox("Çoklu hedefi r ile it:"));
            Menu.Add("ElLeeSin.Combo.R.Count", new Slider("R için say", 2, 2, 4));
            Menu.Add("ElLeeSin.Combo.PassiveStacks", new Slider("Min Stacks Combo", 1, 1, 2));
            Menu.Add("ElLeeSin.Combo.AAStacks", new CheckBox("PAsifi bekle", false));
            Menu.Add("starCombo", new KeyBind("Star Combo Kullan", false, KeyBind.BindTypes.HoldActive, 'T'));
            Menu.AddSeparator();
            ...
            Menu.Add("ElLeeSin.Insec.Ally", new CheckBox("Dostlara insec"));
            Menu.Add("ElLeeSin.Insec.Original.Pos", new CheckBox("Eski pozisyonuna insec"));
            Menu.Add("insecmouse", new CheckBox("Insec fareye", false));
            Menu.Add("ElLeeSin.Flash.Insec", new CheckBox("Flash Insec ward yok", false));
            Menu.Add("checkOthers1", new CheckBox("İnsec için kontrol et", false));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Harass");
            Menu.Add("ElLeeSin.Harass.Q1", new CheckBox("Kullan Q"));
            Menu.Add("ElLeeSin.Harass.Wardjump", new CheckBox("Kullan W"));
            Menu.Add("ElLeeSin.Harass.E1", new CheckBox("Kullan E", false));
            Menu.Add("ElLeeSin.Harass.PassiveStacks", new Slider("Pasif için en az stack ", 1, 1, 2));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Lane Clear");
            Menu.Add("ElLeeSin.Lane.Q", new CheckBox("Kullan Q"));
            Menu.Add("ElLeeSin.Lane.E", new CheckBox("Kullan E"));

            Menu.AddSeparator();

            Menu.AddGroupLabel("Jungle Clear");
            Menu.Add("ElLeeSin.Jungle.Q", new CheckBox("Kullan Q"));
            Menu.Add("ElLeeSin.Jungle.W", new CheckBox("Kullan W"));
            Menu.Add("ElLeeSin.Jungle.E", new CheckBox("Kullan E"));
            Menu.Add("junglePassive", new CheckBox("Orman için pasif kontrol", false));

            Menu.AddSeparator();

            Menu.AddGroupLabel("Ward Jump Ayarları");
            Menu.Add("ElLeeSin.Wardjump", new KeyBind("Wardjump :", false, KeyBind.BindTypes.HoldActive, 'G'));
            Menu.Add("ElLeeSin.Wardjump.MaxRange", new CheckBox("En fazla menzile wardla atla", false));
            Menu.Add("ElLeeSin.Wardjump.Mouse", new CheckBox("Mouse'a atla"));
            Menu.Add("ElLeeSin.Wardjump.Minions", new CheckBox("Minyona atla"));
            Menu.Add("ElLeeSin.Wardjump.Champions", new CheckBox("şampiyona atla"));
            Menu.Add("ElLeeSin.Combo.W", new CheckBox("Komboda ward jump kullan", false));
            Menu.Add("ElLeeSin.Combo.Mode.WW", new CheckBox("Otomatik atak mesafesinde ward jump kullan", false));

            Menu.AddSeparator();

            Menu.AddGroupLabel("Ek.");
            Menu.Add("ElLeeSin.Ignite.KS", new CheckBox("Tutuştur Kullan"));
            Menu.Add("ElLeeSin.Smite.Q", new CheckBox("Q Çarp!", false));
            Menu.Add("bonusRangeA", new Slider("Dostlara bonus menzil", 0, 0, 1000));
            Menu.AddSeparator();
