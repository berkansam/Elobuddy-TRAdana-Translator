...
namespace OKTWJayce
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.AddGroupLabel("Ex : Q1 = Menzilde");
            Menu.AddGroupLabel("Ex : Q2 = Yakın Dövüş");
            Menu.AddSeparator();
            Menu.AddGroupLabel("Combo");
            Menu.Add("autoQ", new CheckBox("Kullan Q1"));
            Menu.Add("autoW", new CheckBox("Kullan W1"));
            Menu.Add("autoE", new CheckBox("Kullan E1 (Q + E)"));
            Menu.AddSeparator();
            Menu.Add("autoQm", new CheckBox("Kullan Q2"));
            Menu.Add("autoWm", new CheckBox("Kullan W2"));
            Menu.Add("autoEm", new CheckBox("Kullan E2"));
            Menu.AddSeparator();
            Menu.Add("autoRm", new CheckBox("Yakın dövüşte otomatik R"));
            Menu.Add("autoR", new CheckBox("Menzilde otomatik R"));
            Menu.AddSeparator();
            ...
            Menu.Add("harassMana", new Slider("Dürtme Mana", 80, 0, 100));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Laneclear");
            Menu.Add("farmQ", new CheckBox("Kullan Q2 + E2"));
            Menu.Add("farmW", new CheckBox("Kullan W1 & W2"));
            Menu.AddSeparator();
            Menu.Add("Mana", new Slider("Mana Yardımcısı", 80, 0, 100));
            Menu.Add("LCminions", new Slider("en az minyon", 2, 0, 10));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Jungle clear");
            Menu.Add("jungleQ", new CheckBox("Kullan Q1"));
            Menu.Add("jungleE", new CheckBox("Kullan E1"));
            Menu.AddSeparator();
            Menu.Add("jungleQm", new CheckBox("Kullan Q2"));
            Menu.Add("jungleWm", new CheckBox("Kullan W2"));
            Menu.Add("jungleEm", new CheckBox("Kullan E2"));
            Menu.AddSeparator();
            Menu.Add("jungleR", new CheckBox("Çalmak için R Kullan"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Drawings");
            Menu.Add("showcd", new CheckBox("Bekleme süresini göster"));
            Menu.Add("onlyRdy", new CheckBox("sadece hazır büyüleri göster"));
            Menu.Add("qRange", new CheckBox("Göster [Q1+E1]/[Q2] Menzili"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Ek");
            Menu.Add("QEsplash", new CheckBox("Q + E Minyona hasar zıplama"));
            Menu.Add("QEsplashAdjust", new Slider("Q + E minyona zıplama yarı çapı", 150, 50, 250));
            Menu.AddSeparator();
            Menu.Add("gapE", new CheckBox("Gapclose R + E2"));
            Menu.Add("intE", new CheckBox("Interrupt Büyüleri"));
            Menu.AddSeparator();
            Menu.Add("autoEks", new CheckBox("E2 sadece KS için kullan?"));
            Menu.AddSeparator();
            Menu.AddLabel("1 : Only Force E1 > Q1 in Combo");
            Menu.AddLabel("2 : Asla kullanma E1 sonra Q1");
            Menu.AddLabel("3 : Her zaman");
            Menu.AddLabel("4 : Sadece E1 > Q1 dürtmede");
            Menu.AddLabel("5 : Sadece E1 > Q1 Kombo ve dürtmede");
            Menu.Add("qeset", new Slider("E1 > Q1 Kombo Ayarları : (^^) ", 3, 1, 5));
            Menu.AddSeparator();
