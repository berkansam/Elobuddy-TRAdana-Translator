...
namespace Riven
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.Add("useR1", new CheckBox("Kullan R1"));
            Menu.Add("ComboW", new CheckBox("Herzaman Kullan W"));
            Menu.AddLabel("R2 Modu : ");
            Menu.Add("R2Mode", new Slider("0 : Ölecekse | 1 : Max Hasar | 2 : First Cast | 3 : Kapalı", 0, 0, 3));
            Menu.AddSeparator();
            Menu.AddLabel("E Modu : ");
            Menu.Add("ComboE", new Slider("0 : Hedefe | 1 : Mouse'a", 0, 0, 1));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Burst Combo");
            Menu.Add("doBurst", new KeyBind("Burs combo yap (Need to redo)", false, KeyBind.BindTypes.HoldActive, 'T'));
            Menu.Add("BurstItem", new CheckBox("İtemleri Kullan"));
            Menu.Add("BurstIgnite", new CheckBox("Tutuştur Kullan"));
            Menu.Add("BurstFlash", new CheckBox("Flash Kullan"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Dürtme");
            Menu.Add("harassQ", new CheckBox("Kullan Q"));
            Menu.Add("harassW", new CheckBox("Kullan W"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("LaneTemizleme");
            Menu.Add("clearQ", new CheckBox("Kullan Q"));
            Menu.Add("clearW", new CheckBox("Kullan W"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("OrmanTemizleme");
            Menu.Add("jungleQ", new CheckBox("Kullan Q"));
            Menu.Add("jungleW", new CheckBox("Kullan W"));
            Menu.Add("jungleE", new CheckBox("Kullan E"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Ek");
            Menu.Add("AutoW", new Slider("Şu kadar düşmana otomatik W", 5, 0, 5));
            Menu.Add("AutoShield", new CheckBox("OTomatik E Kalkan"));
            Menu.Add("Winterrupt", new CheckBox("W interrupt"));
            Menu.Add("KeepQALive", new CheckBox("Q kullan canlı kalmak için"));
            Menu.AddSeparator();
            Menu.Add("KillStealQ", new CheckBox("KS'de Q Kullan"));
            Menu.Add("KillStealW", new CheckBox("KS'de W Kullan"));
            Menu.Add("KillStealE", new CheckBox("KS'de E Kullan"));
            Menu.Add("KillStealR", new CheckBox("KS'de R Kullan"));
            Menu.AddSeparator();
            Menu.Add("Spell", new Slider("Büyü Kullanma Gecikmesi :", 0, 0, 100));
            Menu.AddSeparator();
