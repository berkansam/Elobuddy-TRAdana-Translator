...
namespace KogMaw
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.Add("useQ", new CheckBox("Kullan Q"));
            Menu.Add("useW", new CheckBox("Kullan W"));
            Menu.Add("useE", new CheckBox("Kullan E"));
            Menu.Add("useR", new CheckBox("Kullan R"));
            Menu.Add("manaW", new CheckBox("W için mana tut"));
            Menu.Add("dontw", new KeyBind("Kombo yaparken hareket etme", false, KeyBind.BindTypes.PressToggle, 'A'));
            Menu.Add("rLimit", new Slider("R stack limiti", 3, 1, 6));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Dürtme");
            Menu.Add("useQH", new CheckBox("Kullan Q"));
            Menu.Add("useEH", new CheckBox("Kullan E"));
            Menu.Add("useRH", new CheckBox("Kullan R"));
            Menu.Add("rLimitH", new Slider("R stack limit", 1, 1, 6));
            Menu.Add("manaH", new Slider("Dürtmek için gereken mana :", 60, 1, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("LaneTemizleme");
            Menu.Add("useELC", new CheckBox("Kullan E"));
            Menu.Add("useRLC", new CheckBox("Kullan R"));
            Menu.Add("rLimitLC", new Slider("R stack limit", 1, 1, 6));
            Menu.Add("manaLC", new Slider("Lanetemizleme için gereken mana :", 60, 1, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("OrmanTemizleme");
            Menu.Add("useWJG", new CheckBox("Kullan W"));
            Menu.Add("useEJG", new CheckBox("Kullan E"));
            Menu.Add("useRJG", new CheckBox("Kullan R"));
            Menu.Add("rLimitJG", new Slider("R stack limit", 2, 1, 6));
            Menu.Add("manaJG", new Slider("Orman temizleme için mana :", 60, 1, 100));
            Menu.AddSeparator();
            Menu.Add("human", new KeyBind("İnsancıl ayardır açın veya kapatın", false, KeyBind.BindTypes.PressToggle, 'T'));
            Menu.Add("esw", new Slider("Enabled SWalk/NWalk at :", 225, 0, 500));
