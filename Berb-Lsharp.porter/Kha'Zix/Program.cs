...
namespace KhaZix
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.Add("UseQCombo", new CheckBox("Kullan Q"));
            Menu.Add("UseWCombo", new CheckBox("Kullan W"));
            Menu.Add("UseECombo", new CheckBox("Kullan E"));
            Menu.Add("UseRCombo", new CheckBox("Kullan R"));
            Menu.Add("UseItems", new CheckBox("Use Items"));
            Menu.AddSeparator();
            Menu.Add("UseEGapclose", new CheckBox("Gapclose için E"));
            Menu.Add("UseEGapcloseW", new CheckBox("Gapclose için W"));
            Menu.Add("UseRGapcloseW", new CheckBox("uzun Gapcloser için R"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Dürtme");
            Menu.Add("UseQHarass", new CheckBox("Kullan Q"));
            Menu.Add("UseWHarass", new CheckBox("Kullan W"));
            Menu.Add("Harass.AutoWI", new CheckBox("Otomatik-W Hareketsiz"));
            Menu.Add("Harass.AutoWD", new CheckBox("Otomatik W"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("LaneTemizleme");
            Menu.Add("UseQFarm", new CheckBox("Kullan Q"));
            Menu.Add("UseEFarm", new CheckBox("Kullan E"));
            Menu.Add("UseWFarm", new CheckBox("Kullan W"));
            Menu.Add("Farm.WHealth", new Slider("W için gereken can", 80, 0, 100));
            Menu.Add("UseItemsFarm", new CheckBox("İtemleri Kullan", true));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Çift Zıplama");
            Menu.Add("djumpenabled", new CheckBox("Aktif"));
            Menu.Add("delayQ", new Slider("Q gecikmesi", 1, 1, 5));
            Menu.Add("JEDelay", new Slider("Zıplama gecikmesi", 250, 250, 500));
            Menu.Add("jumpmode", new Slider("1 : Varsayılan  | 2 : Özel - Ayarlar Aşağıda", 1, 1, 2));
            Menu.AddSeparator();
            Menu.Add("save", new CheckBox("Çift zıplama yeteneği"));
            Menu.Add("noauto", new CheckBox("Q bekle"));
            Menu.Add("jcursor", new CheckBox("İmlece zıpla (true) veya Script belirlediği yere"));
            Menu.Add("jcursor2", new CheckBox("İkinci zıplama imlece (true) veya script belirlediği yere"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Güvenlik");
            Menu.Add("Safety.Enabled", new CheckBox("Güvenlik kontrolü aktif"));
            Menu.Add("Safety.CountCheck", new CheckBox("Zıplama için en az düşman"));
            Menu.Add("Safety.TowerJump", new CheckBox("Kule Altına dalma"));
            Menu.Add("Safety.Override", new KeyBind("Güvenliği iptal etme tuşu", false, KeyBind.BindTypes.HoldActive, 'T'));
            Menu.Add("Safety.MinHealth", new Slider("Canım %", 15, 0, 100));
            Menu.Add("Safety.Ratio", new Slider("Dost:Düşman Oranı (/5)", 1, 0, 5));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Kill Steal Ayarları");
            Menu.Add("Kson", new CheckBox("Kullan KillSteal"));
            Menu.Add("UseQKs", new CheckBox("Kullan Q"));
            Menu.Add("UseWKs", new CheckBox("Kullan W"));
            Menu.Add("UseEKs", new CheckBox("Kullan E"));
            Menu.Add("Ksbypass",  new CheckBox("KS için güvenli E kullan", false));
            Menu.Add("UseEQKs",  new CheckBox("KSde EQ kullan"));
            Menu.Add("UseEWKs",  new CheckBox("KSde EW KUllan"));
            Menu.Add("UseTiamatKs",  new CheckBox("İtemleri kullan"));
            Menu.Add("Edelay", new Slider("E gecikmesi (ms)", 0, 0, 300));
            Menu.Add("UseIgnite",  new CheckBox("Tutuştur kullan"));
            Menu.AddSeparator();
