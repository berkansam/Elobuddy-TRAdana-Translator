...
namespace Jinx
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.Add("autoSwitch", new Slider("Roket geçişi için düşman sayısı >= ", 2, 1, 5));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Harass");
            Menu.Add("useQH", new CheckBox("Kullan Q"));
            Menu.Add("useWH", new CheckBox("Kullan W"));
            Menu.Add("manaH", new Slider("Eğer manam şundan çoksa > ", 65, 0, 100));
            Menu.Add("autoH", new KeyBind("Otomatik Dürt", false, KeyBind.BindTypes.PressToggle, 'T'));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Lane Clear");
            Menu.Add("useQLC", new CheckBox("Kullan Q"));
            Menu.Add("manaLC", new Slider("Eğer manam şundan çoksa > ", 65, 0, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Jungle Clear");
            Menu.Add("useQJG", new CheckBox("Kullan Q"));
            Menu.Add("useWJG", new CheckBox("Kullan W"));
            Menu.Add("manaJG", new Slider("Eğer manam şundan çoksa > ", 65, 0, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Last Hit");
            Menu.Add("useQLH", new CheckBox("Kullan Q"));
            Menu.Add("manaLH", new Slider("Eğer manam şundan çoksa > ", 65, 0, 100));
            Menu.AddSeparator();
            Menu.Add("autoR", new CheckBox("Ölecek hedefe otomatik R"));
            Menu.Add("autoE", new CheckBox("Hareketsiz kalan hedefe otomatik E"));
