...
namespace Perfect_Olaf
{
    ...
    class Program
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            FarmingMenu.Add("WLaneClear", new CheckBox("W Kullanr"));
            ...
            FarmingMenu.Add("QlasthitMana", new Slider("Manam < %", 45, 0, 100));

            SetSmiteSlot();
            if (SmiteSlot != SpellSlot.Unknown)
            {
                SmiteMenu = Menu.AddSubMenu("Çarp Kullanma", "SmiteUsage");
                SmiteMenu.AddLabel("Çarp Kullanma");
            ...
            MiscMenu.Add("autoR", new CheckBox("Tehlikeli büyülerden kaçmak için R kullan",false));
            MiscMenu.Add("autoEenemyHP", new Slider("Düşmanın canı < %", 45, 0, 100));
            MiscMenu.AddSeparator();
            MiscMenu.AddLabel("İtemler");
            MiscMenu.AddLabel("Mahvolmuş Kılıç");
            ...
            MiscMenu.Add("useCrystal", new CheckBox("Tüketilebilir iksir kullan"));
            ...
            UpdateMenu = Menu.AddSubMenu("Son Güncelleme Kayıtları", "Updates");
            UpdateMenu.AddLabel("V0.1.7.0");
            UpdateMenu.AddLabel("-Q İsabet Oranı Güncellendi! Lütfen İsabet Oranı ayarını yapınız");
            UpdateMenu.AddLabel("İsabet Oranı");
            UpdateMenu.AddLabel("  Algoritma");
            UpdateMenu.AddLabel("    Hitchance = 4");
            UpdateMenu.AddLabel("  Collision");
            UpdateMenu.AddLabel("    Extra Hitbox Radius = 40");
            UpdateMenu.AddLabel("Çeviri tradana iyi oyunlar diler")
