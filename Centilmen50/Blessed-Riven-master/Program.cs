...
namespace Blessed_Riven
{
    class Program
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            Chat.Print("Blessed Riven Yuklendi,tradana iyi oyunlar diler.", Color.Brown);
            ...
            ComboMenu.AddLabel("Burst = Hedefi Seç ve Burst Tuşuna bas");
            ComboMenu.AddLabel("Flash Kullanım");
            ComboMenu.AddLabel("If not perform without a flash");
            ComboMenu.Add("ForcedR", new KeyBind("Zorunlu R", true, KeyBind.BindTypes.PressToggle, 'Z'));
            ComboMenu.Add("useTiamat", new CheckBox("İtemleri Kullan"));
            ComboMenu.AddLabel("R Ayarları");
            ComboMenu.Add("RCantKill", new CheckBox("Kombo İle Öldürme", false));
            ...
            FarmingMenu = Menu.AddSubMenu("Clear Ayarları", "FarmSettings");
            FarmingMenu.AddLabel("Lane Ayarları");
            ...
            MiscMenu = Menu.AddSubMenu("Ek Ayarları", "Misc");
            MiscMenu.AddLabel("Otomatik");
            MiscMenu.Add("UseShield", new CheckBox("Kalkan Kullan(E)"));
            MiscMenu.Add("AutoIgnite", new CheckBox("Otomatik Tutuştur"));
            MiscMenu.Add("AutoQSS", new CheckBox("Otomatik QSS"));
            MiscMenu.Add("AutoW", new CheckBox("Otomatik W"));
            MiscMenu.AddLabel("Hayatta Kalma Ayarları");
            MiscMenu.Add("Alive.Q", new CheckBox("Hayatta Kalmak için Q Kullan?"));
            MiscMenu.Add("Alive.R", new CheckBox("R2 bitmeden önce Kullan"));
            MiscMenu.AddLabel("Ekstra");
            MiscMenu.Add("interrupter", new CheckBox("Interruptable Büyüleri Kullan"));
            MiscMenu.Add("gapcloser", new CheckBox("Gapclose Büyüleri Kullan"));
            ...
            MiscMenu.Add("useElixir", new CheckBox("Ek İksir(ad ap artıran)"));
            MiscMenu.Add("useElixirCount", new Slider("Düşman Say > ", 1, 0, 4));
            MiscMenu.Add("useCrystal", new CheckBox("Yeniden Doldurulabilir İksir"));
            MiscMenu.Add("useCrystalHPV", new Slider("Canım < %", 65, 0, 100));
            MiscMenu.Add("useCrystalManaV", new Slider("Manam < %", 65, 0, 100));

            DelayMenu = Menu.AddSubMenu("Gecikme Ayarları(Humanizer)", "Delay");
            DelayMenu.Add("useHumanizer", new CheckBox("İnsancıl Kullanma?", false));
            ...
            DelayMenu.Add("spell4a", new Slider("R Gecikme(ms)", 0, 0, 400));
            DelayMenu.Add("spell4b", new Slider("R2 gecikme(ms)", 100, 50, 400));

            Skin = Menu.AddSubMenu("Skin Değiştirici", "SkinChanger");
            Skin.Add("checkSkin", new CheckBox("Skin Değiştirici Kullan"));
            Skin.Add("skin.Id", new Slider("SkinNumarası", 4, 0, 6));

            DrawMenu = Menu.AddSubMenu("Göstergeler", "Drawings");
            DrawMenu.Add("drawStatus", new CheckBox("Göster Durumu"));
            DrawMenu.Add("drawCombo", new CheckBox("Göster Kombo Menzili"));
            DrawMenu.Add("drawFBurst", new CheckBox("Göster Flash Burst Menzili"));
            DrawMenu.Add("DrawDamage", new CheckBox("Göster Hasar Çubuğu"));
