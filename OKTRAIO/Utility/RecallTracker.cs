...
namespace OKTRAIO.Utility
{
    ...
    public class RecallTracker : UtilityAddon
    {
        ...
        {
            return new UtilityInfo(this, "Geri Dönüş Takipçisi", "recalltracker", "Unknown");
        }

        protected override void InitializeMenu()
        {
            Menu.AddGroupLabel("OKTR AIO - RecallTracker for " + Player.Instance.ChampionName, "recall.grouplabel.utilitymenu");
            Menu.AddCheckBox("recall.use", "Geri Dönüş Takipçisini Kullan");
            Menu.Add("recall.advanced", new CheckBox("Gelişmiş Menüyü Göster", false)).OnValueChange += Value.AdvancedModeChanged;
            Menu.AddCheckBox("recall.recallsEnemy", "Düşmanın Geri Dönüşünü Göster", true, true);
            Menu.AddCheckBox("recall.recallsAlly", "Dostların Geri Dönüşünü Göster", true, true);
            Menu.AddSlider("recall.x", "Geri Dönüş Yeri X", (int)(Drawing.Width * 0.4), 0, Drawing.Width, true);
            Menu.AddSlider("recall.y", "Geri Dönüş Yeri Y", (int)(Drawing.Height * 0.75), 0, Drawing.Height, true);
            Menu.AddSlider("recall.width", "Geri Dönüş Barı Kalınlığı", 300, 200, 500, true);
        }
