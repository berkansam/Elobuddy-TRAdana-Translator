    ...
    internal class Varus : AIOChampion
    {
        ...
        public override void Init()
        {
            try
            {
                ...
                MainMenu.Combo.AddCheckBox("combo.q.stacks", "Sadece yük varsa Q kullan", false, true);
                MainMenu.Combo.AddSlider("combo.q.stacks.min", "Q için en az yük", 3, 1, 3, true);
                MainMenu.Combo.AddCheckBox("combo.e.stacks", "Sadece yükler varsa E kullan", true, true);
                MainMenu.Combo.AddSlider("combo.e.stacks.min", "E için en az yük", 3, 1, 3, true);
                MainMenu.Combo.Add("combo.r.assist",
                    new KeyBind("Semi-Auto Ult", false, KeyBind.BindTypes.HoldActive, 'G'));
                MainMenu.Combo.AddCheckBox("combo.r.aoe", "R kullan için AOE", true, true);
                MainMenu.Combo.AddSlider("combo.r.slider", "{0} R şu kadar düşmana çarpıp yavaşlatacaksa", 3, 1, 5, true);

                //harass
                MainMenu.HarassKeys(useW: false, useR: false);
                MainMenu.Harass.AddSeparator();
                MainMenu.Harass.AddCheckBox("harass.q.stacks", "Q sadece yük varsa", false, true);
                MainMenu.Harass.AddSlider("harass.q.stacks.min", "Q için en az yük", 3, 1, 3, true);
                MainMenu.Harass.AddCheckBox("harass.e.stacks", "E sadece yük varsa", false, true);
                MainMenu.Harass.AddSlider("harass.e.stacks.min", "E için en az yük", 3, 1, 3, true);
                MainMenu.Harass.AddSeparator();
                MainMenu.Harass.AddGroupLabel("Mana Yardımcısı:", "harass.grouplabel.addonmenu", true);
                ...
                MainMenu.Lane.AddGroupLabel("Dürtme Ayarları", "lane.grouplabel.addonmenu", true);
                MainMenu.Lane.AddCheckBox("lane.q.harass", "Q kullan", false, true);
                MainMenu.Lane.AddCheckBox("lane.e.harass", "E kullan", false, true);
                MainMenu.Lane.AddSeparator();
                MainMenu.Lane.AddCheckBox("lane.q.stacks", "Q kullan sadece yük varsa", false, true);
                MainMenu.Lane.AddSlider("lane.q.stacks.min", "Q için gereken yük", 3, 1, 3, true);
                MainMenu.Lane.AddCheckBox("lane.e.stacks", "E kullan sadece yük varsa", false, true);
                MainMenu.Lane.AddSlider("lane.e.stacks.min", "E için en az yük", 3, 1, 3, true);
                MainMenu.Lane.AddSeparator();
                MainMenu.Lane.AddGroupLabel("Farm Ayarları", "lane.grouplabel1.addonmenu", true);
                MainMenu.Lane.AddSlider("lane.q.min", "Q için en az minyon", 3, 1, 7, true);
                MainMenu.Lane.AddSlider("lane.e.min", "E için en az minyon", 3, 1, 7, true);
                MainMenu.Lane.AddGroupLabel("Mana Yardımcısı:", "lane.grouplabel2.addonmenu", true);
                ...
                MainMenu.Jungle.AddSlider("jungle.q.min", "Q için için en az minyon", 3, 1, 4, true);
                MainMenu.Jungle.AddSlider("jungle.e.min", "E için için en az minyon", 3, 1, 4, true);
                MainMenu.Jungle.AddGroupLabel("Mana Yardımcısı:", "jungle.grouplabel.addonmenu", true);
                MainMenu.JungleManaManager(true, false, true, false, 20, 0, 20, 0);

                //lasthit
                MainMenu.LastHitKeys(false, useW: false, useE: false, useR: false);
                MainMenu.Lasthit.AddCheckBox("lasthit.q.siege", "E kullan Siege Minions");
                MainMenu.Lasthit.AddSeparator();
                MainMenu.Lasthit.AddGroupLabel("Mana Yardımcısı:", "lasthit.grouplabel.addonmenu", true);
                ...
                MainMenu.Flee.AddGroupLabel("Mana Yardımcısı:", "flee.grouplabel.addonmenu", true);
                ...
                //misc
                MainMenu.MiscMenu();
                MainMenu.Misc.AddCheckBox("misc.r.interrupt", "Interrupt R kullan ");
                MainMenu.Misc.AddCheckBox("misc.e.gapcloser", "Anti-Gapcloser E kullan ");
                ...
                MainMenu.Misc.AddCheckBox("misc.q.knockup", "Q ile düşmana vur", true, true);
                MainMenu.Misc.AddCheckBox("misc.q.snare", "Yavaşlamış Düşmana Q kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.q.suppression", "Q ile düşmanı önle", true, true);
                ...
                MainMenu.Misc.AddCheckBox("misc.e.stun", "Sabitlenmiş Düşmana E kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.e.knockup", "E ile düşmana vur", true, true);
                MainMenu.Misc.AddCheckBox("misc.e.snare", "Yavaşlamış Düşmana E kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.e.suppression", "E ile düşmanı önle", true, true);
                MainMenu.Misc.AddCheckBox("misc.e.taunt", "Düşmanla Alay Etmek için E kullan", true, true);
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("İsabet Oranı", "misc.grouplabel1.addonmenu", true);
                MainMenu.Misc.AddSlider("misc.q.prediction", "Q için İsabet Oranı", 80, 0, 100, true);
                MainMenu.Misc.AddSlider("misc.e.prediction", "E için İsabet Oranı", 80, 0, 100, true);
                MainMenu.Misc.AddSlider("misc.r.prediction", "R için İsabet Oranı", 80, 0, 100, true);

                //draw
                MainMenu.DrawKeys(useW: false);
                MainMenu.Draw.AddSeparator();
                MainMenu.Draw.AddCheckBox("draw.hp.bar", "Göster Combo Hasarı", true, true);
            }
