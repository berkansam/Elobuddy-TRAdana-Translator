        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.Combo.AddGroupLabel("İsabet Oranı Ayarları", "combo.grouplabel.2", true);
                    MainMenu.Combo.AddSlider("combo.e.prediction", "E için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddSeparator();
                    ...
                    MainMenu.Jungle.AddGroupLabel("Orman Temizleme Ayarları", "jungle.grouplabel.1", true);
                    ...
                    MainMenu.Jungle.AddCheckBox("jungle.minimonsters.spell", "Küçük Canavalarda Büyü Kullan", false,
                        true);
                    MainMenu.Jungle.AddSeparator();
                    MainMenu.Jungle.AddGroupLabel("Mana Yardımcısı:", "jungle.grouplabel.2", true);
                    ...
                    MainMenu.Harass.AddGroupLabel("Mana Yardımcısı:", "harass.grouplabel.1", true);
                    ...
                    MainMenu.Ks.AddGroupLabel("Mana Yardımcısı:", "killsteal.grouplabel.5", true);
                    MainMenu.KsManaManager(false, false, true, true, 60, 50, 10, 25);

                    //Misc Menu
                    MainMenu.MiscMenu();
                    MainMenu.Misc.AddCheckBox("misc.e.interrupter", "Interrupt için E kullan ");
                    MainMenu.Misc.AddCheckBox("misc.e.gapcloser", "Anti-GapCloser için E kullan ");
                    MainMenu.Misc.AddCheckBox("misc.e", "Otomatik E kullan");
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Interrupter - AntiGapCloser Ayarları", "misc.grouplabel.1", true);
                    MainMenu.Misc.AddSlider("misc.e.interrupter.mana", "interrupt için en az mana ", 30, 0, 100, true);
                    MainMenu.Misc.AddSlider("misc.e.gapcloser.mana", "Anti-GapCloser R için en az mana ", 30, 0,
                        100, true);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Otomatik E Ayarları", "misc.grouplabel.2", true);
                    ...
                    MainMenu.Misc.AddSlider("misc.e.mana", "E için Bu Ayarları Manam Şunun Üstündeyse Kullan {0}%", 10, 0, 100,
                        true);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Balta Ayarları", "misc.grouplabel.3", true);
                    MainMenu.Misc.AddCheckBox("misc.w.axe", "W eğer gerekliyse", true, true);
                    MainMenu.Misc.AddCheckBox("misc.axe.tower", "Duvarın altında açma", true, true);
                    MainMenu.Misc.AddCheckBox("misc.axe.arf", "Ben balta istiyorum!!", false, true);
                    MainMenu.Misc.AddCheckBox("misc.axe.check", "Tutmasını Denetle", true, true);
                    MainMenu.Misc.AddSlider("misc.axe.check.enemies", "en fazla düşmanı Tut", 2, 1, 5, true);
                    MainMenu.Misc.AddSlider("misc.axe.count", "En fazla balta", 2, 1, 3, true);
                    MainMenu.Misc.AddSlider("misc.axe.range", "Tutma Menzili", 800, 120, 1500, true);
                    MainMenu.Misc.AddGroupLabel("Eğer balta tutuyorsa:", "misc.grouplabel.5", true);
                    MainMenu.Misc.AddComboBox("misc.axe.mode", "Tutma Metodu", new List<string> {"Kombo","Hiç","Orbwalking (Under Development)"},2,true);
                    ...
                    //Draw Menu
                    MainMenu.DrawKeys();
                    MainMenu.Draw.AddCheckBox("draw.axe.catch", "Göster Tutma Menzili");
