        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.Combo.AddGroupLabel("Combo Ayarları", "combo.grouplabel.1", true);
                    MainMenu.Combo.AddCheckBox("combo.e.forced", "Hedefi E ile zorla ", true, true);
                    MainMenu.Combo.AddCheckBox("combo.e.r", "E+R ile bitirici darbe", true, true);
                    MainMenu.Combo.AddCheckBox("combo.r.tower", "Düşman Dost kuleye fırlatılabilecekse R kullan", true, true);
                    MainMenu.Combo.AddSlider("combo.w.range",
                        "Eğer hedef menzildeyse W kullanma, W için gerekli düşman", 1, 1, 5, true);
                    MainMenu.Combo.AddSlider("combo.w.e", "Zıplama için en fazla düşman", 1, 1, 5, true);
                    MainMenu.Combo.AddSlider("combo.e.r.damages", "E + R Hızlıkill", 60, 1, 500, true);
                    MainMenu.Combo.AddSlider("combo.r.damage", "R HızlıKill", 50, 1, 500, true);
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("İsabet Oranı Ayarları", "combo.grouplabel.2", true);
                    MainMenu.Combo.AddSlider("combo.w.prediction", "W için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddSeparator();
                    ...
                    MainMenu.Lane.AddCheckBox("lane.e.forced", "E ile minyonu zorla ", true, true);
                    MainMenu.Lane.AddCheckBox("lane.save.tower", "E tut kuleye atmak için", true, true);
                    MainMenu.Lane.AddSeparator();
                    ...
                    MainMenu.Jungle.AddGroupLabel("Jungleclear Ayarları", "jungle.grouplabel.1", true);
                    ...
                    MainMenu.Flee.AddGroupLabel("HP Yardımcısı", "flee.grouplabel.1", true);
                    ...
                    MainMenu.Misc.AddCheckBox("misc.e", "Otomatik E ");
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Interrupter - AntiGapCloser Ayarları", "misc.grouplabel.6", true);
                    MainMenu.Misc.AddSlider("misc.r.interrupter.mana", "interrupt için en az mana ", 30, 0, 100, true);
                    MainMenu.Misc.AddSlider("misc.r.gapcloser.mana", "R ile Anti-GapCloser için en az mana", 30, 0,
                        100, true);
                    MainMenu.Misc.AddGroupLabel("Otomatik E Ayarları", "misc.grouplabel.3", true);
