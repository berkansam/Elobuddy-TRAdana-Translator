        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.Lane.Add("lane.mana", new Slider("LaneClear'da Q için en az mana", 80));
                    ...
                    //Misc Menu
                    MainMenu.MiscMenu();
                    MainMenu.Misc.Add("misc.farmQAARange", new CheckBox("Minyon AA menzilindeyse Q kullan"));
                    MainMenu.Misc.Add("misc.teleportE", new CheckBox("Işınlanan kişiye E kullan"));
                    MainMenu.Misc.Add("misc.spellcastE", new CheckBox("Use E OnProcessSpellCast"));
                    MainMenu.Misc.Add("misc.enemyTurretR", new CheckBox("Düşmanın Kule Altında R kullanma"));
