        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.Combo.AddGroupLabel("Combo Ayarları", "combo.grouplabel.addonmenu", true);
                    MainMenu.Combo.AddCheckBox("combo.aa", "E stacklanan Kişiye focus atmak", true, true);
                    MainMenu.Combo.AddCheckBox("combo.q.aa", "AA'dan sonra Q kullan", true, true);
                    MainMenu.Combo.AddCheckBox("combo.q.collision", "Çarpışmada Q kontrol et", true, true);
                    MainMenu.Combo.AddCheckBox("combo.q.minions", "Minyonun içinden hedefe doğru Q kullan", true,
                        true);
                    MainMenu.Combo.AddCheckBox("combo.e.auto", "Hedef menzilden çıkarsa E kullan", false, true);
                    MainMenu.Combo.AddCheckBox("combo.e.death", "Eğer ölecekse E kullan", false, true);
                    MainMenu.Combo.AddSlider("combo.e.range", "E için min menzil {0} ", 600, 100, 600, true);
                    MainMenu.Combo.AddSlider("combo.e.damage", "E KillÜzerinde", 60, 0, 500, true);
                    MainMenu.Combo.AddSlider("combo.e.damage.me", "E kullan eğer hedefin canı geçerse? {0} ", 10, 0, 100, true);
                    MainMenu.Combo.AddCheckBox("combo.r.allin.prevent", "Müttefik için R kullan", false, true);
                    MainMenu.Combo.AddCheckBox("combo.r.allin", "Use R if u guys can kill those faggs", false, true);
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("İsabet Oranı Ayarları", "combo.grouplabel.addonmenu.2", true);
                    MainMenu.Combo.AddSlider("combo.q.prediction", "Q için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("Mana Manager:", "combo.grouplabel.addonmenu.3", true);
                    MainMenu.Combo.AddCheckBox("combo.e.save.mana", "E için Mana sakla", true, true);
                    MainMenu.Combo.AddCheckBox("combo.r.save.mana", "R için mana sakla", true, true);
                    ...
                    MainMenu.Lane.AddGroupLabel("Laneclear Ayarları", "lane.grouplabel.addonmenu", true);
                    MainMenu.Lane.AddCheckBox("lane.refresh.buff", "Refresh the minion target if E Killable", true, true);
                    MainMenu.Lane.AddGroupLabel("Mana Yardımcısı:", "lane.grouplabel.addonmenu.2", true);
                    ...
                    MainMenu.Jungle.AddGroupLabel("Jungleclear Ayarları", "jungle.grouplabel.addonmenu", true);
                    MainMenu.Jungle.AddCheckBox("jungle.monsters.spell", "Büyük Canavalarda Büyü Kullan", true, true);
                    MainMenu.Jungle.AddCheckBox("jungle.minimonsters.spell", "Küçük Canavalarda Büyü Kullan", false,
                        true);
                    MainMenu.Jungle.AddCheckBox("jungle.monsters.ally", "Bufları çal-ma", true, true);
                    MainMenu.Jungle.AddSeparator();
                    MainMenu.Jungle.AddGroupLabel("Mana Yardımcısı:", "jungle.grouplabel.addonmenu.2", true);
                    ...
                    MainMenu.Lasthit.AddGroupLabel("LastHit Ayarları", "lasthit.grouplabel.addonmenu", true);
                    MainMenu.Lasthit.AddSlider("lasthit.q.count", "Q için gerekli minyon", 2, 1, 10, true);
                    MainMenu.Lasthit.AddSlider("lasthit.e.count", "E için gerekli minyon", 4, 1, 10, true);
                    MainMenu.Lasthit.AddGroupLabel("Mana Yardımcısı:", "lasthit.grouplabel.addonmenu.2", true);
                    ...
                    MainMenu.Harass.AddGroupLabel("Dürtme Ayarları", "harass.grouplabel.addonmenu", true);
                    MainMenu.Harass.AddCheckBox("harass.q.trough", "Q atmak için E yükü gerekli", true, true);
                    MainMenu.Harass.AddCheckBox("harass.e.minions", "Minyonlardan E çekerek hedefi dürt", true, true);
                    MainMenu.Harass.AddCheckBox("harass.aa.mark", "Hedefi zorla W pasifi ile", true, true);
                    MainMenu.Harass.AddSeparator();
                    MainMenu.Harass.AddGroupLabel("Mana Yardımcısı:", "harass.grouplabel.addonmenu.2", true);
                    ...
                    MainMenu.Flee.AddGroupLabel("Flee Ayarları", "flee.grouplabel.addonmenu", true);
                    MainMenu.Flee.AddCheckBox("flee.q.wall", "Q kullan duvardan atlamak için", true, true);
                    MainMenu.Flee.AddCheckBox("flee.aa.gapcloser", "Hedefe Ulaşmak için AA kullan / veya kaçmak için", true, true);

                    //Ks
                    MainMenu.KsKeys(useW: false);
                    MainMenu.Ks.AddSeparator();
                    MainMenu.Ks.AddGroupLabel("Mana Yardımcısı:", "killsteal.grouplabel.addonmenu", true);
                    MainMenu.KsManaManager(true, false, true, false, 20, 30, 10, 5);

                    //Misc Menu
                    MainMenu.MiscMenu();
                    MainMenu.Misc.AddCheckBox("misc.q.gapcloser", "GapCloser için Q kullan ", false);
                    MainMenu.Misc.AddCheckBox("misc.r.gapcloser", "Eğer Arkadaşın ölecekse r kullan", false);
                    MainMenu.Misc.AddCheckBox("misc.q", "Topluluğa otomatik Q kullan");
                    MainMenu.Misc.AddCheckBox("misc.w.auto", "Otomatik W kulan", false);
                    MainMenu.Misc.AddCheckBox("misc.r.save", "Otomatik R kullan sadece dosta");
                    MainMenu.Misc.AddCheckBox("misc.aa.exploit", "Çift Zıplama Exploit Kullan");
                    MainMenu.Misc.AddCheckBox("misc.passive.pact", "Anlaşma Kullan", false);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Otomatik Q Ayarları", "misc.grouplabel.addonmenu", true);
                    MainMenu.Misc.AddCheckBox("misc.q.stun", "Sabitlenmiş Düşmana Q kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.charm", "Use Q on Charmed Enemy", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.taunt", "Düşmanla Alay Etmek için Q kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.fear", "Korkmuş Düşmana Q kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.snare", "Yavaşlamış Düşmana Q kullan", true, true);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("W Ayarları", "misc.grouplabel.addonmenu.2", true);
                    MainMenu.Misc.AddCheckBox("misc.w.alarm", "Gözcü hasar aldığında beni uyar", true, true);
                    MainMenu.Misc.AddCheckBox("misc.w.alarm.sound", "Gözcü bildirimleri aktif", true, true);
                    MainMenu.Misc.AddCheckBox("misc.w.interrupt", "Interrupt W Eğer kombo tuşu basılıysa", true, true);
                    ...
                    MainMenu.Misc.AddGroupLabel("Mana Yardımcısı:", "misc.grouplabel.addonmenu.3", true);
                    MainMenu.Misc.AddSlider("misc.q.mana", "Q için manam şunun üzerinde {0}%", 30, 0, 100,
                        true);
                    MainMenu.Misc.AddSlider("misc.w.mana", "W için manam şunun üzerinde {0}%", 70, 0, 100,
                        true);
                    MainMenu.Misc.AddSlider("misc.r.mana", "R için manam şunun üzerinde {0}%", 30, 0, 100,
                        true);

                    //Draw Menu
                    MainMenu.DrawKeys();
                    MainMenu.Draw.AddSeparator();
                    MainMenu.Draw.AddCheckBox("draw.hp.bar", "Göster Kombo Hasarı", true, true);
                    MainMenu.Draw.AddCheckBox("draw.w.alarm.text", "Gözcü Yazı bildirimleri aktif", true, true);
                    Value.Init();
                }
                catch (Exception e)
                {
