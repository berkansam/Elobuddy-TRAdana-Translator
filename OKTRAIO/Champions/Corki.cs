        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.Combo.AddGroupLabel("Kombo Ayarlarý", "combo.grouplabel.addonmenu", true);
                    MainMenu.Combo.AddSlider("combo.e.range", "E için en az menzil", 600, 100, 600, true);
                    MainMenu.Combo.AddSlider("combo.w.e", "zýplama için en fazla düþman", 1, 0, 5, true);
                    MainMenu.Combo.AddSlider("combo.q.damage", "Q hýzlýkill", 60, 0, 500, true);
                    MainMenu.Combo.AddSlider("combo.r.damage", "R hýzlýkill", 50, 0, 500, true);
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("Ýsabet Oraný Ayarlarý", "combo.grouplabel.1", true);
                    MainMenu.Combo.AddSlider("combo.q.prediction", "Ýsabet Oraný Q için > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddCheckBox("combo.q.multipred", "Q Kullan OKTR Çoklu hedef Ýsabet Oraný", true, true);
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("Mana Yardýmcýsý:", "combo.grouplabel.addonmenu.1", true);
                    ...
                    MainMenu.Lane.AddGroupLabel("Mana Yardýmcýsý:", "lane.grouplabel.addonmenu.1", true);
                    ...
                    MainMenu.Jungle.AddGroupLabel("Jungleclear Ayarlarý", "jungle.grouplabel.addonmenu", true);
                    ...
                    MainMenu.Jungle.AddCheckBox("jungle.minimonsters.spell", "Küçük Canavalarda Büyü Kullan", false,
                        true);
                    MainMenu.Jungle.AddSeparator();
                    MainMenu.Jungle.AddGroupLabel("Mana Yardýmcýsý:", "jungle.grouplabel.addonmenu.1", true);
                    ...
                    MainMenu.Lasthit.AddGroupLabel("Mana Yardýmcýsý:", "lasthit.grouplabel.addonmenu", true);
                    ...
                    MainMenu.Harass.AddGroupLabel("Dürtme Ayarlarý", "harass.grouplabel.addonmenu.12", true);
                    MainMenu.Harass.AddSlider("harass.e.range", "Min range for cast E", 600, 100, 600, true);
                    MainMenu.Harass.AddSeparator();
                    MainMenu.Harass.AddGroupLabel("Mana Yardýmcýsý:", "harass.grouplabel.addonmenu", true);
                    ...
                    MainMenu.Flee.AddGroupLabel("HP Yardýmcý Ayarlarý", "flee.grouplabel.addonmenu", true);
                    MainMenu.Flee.AddSlider("flee.r.hp", "Senin canýn þundan azsa R kullan {0}%", 20, 0, 100, true);

                    //Ks
                    MainMenu.KsKeys(useE: false, defaultW: false);
                    MainMenu.Ks.AddSeparator();
                    MainMenu.Ks.AddGroupLabel("Mana Yardýmcýsý:", "killsteal.grouplabel.addonmenu", true);
                    MainMenu.KsManaManager(true, true, false, true, 20, 30, 10, 5);

                    //Misc Menu
                    MainMenu.MiscMenu();
                    MainMenu.Misc.AddCheckBox("misc.q", "Otomatik Q kullan");
                    MainMenu.Misc.AddCheckBox("misc.w.gapcloser", "Otomatik W kullan GapCloser", false);
                    MainMenu.Misc.AddCheckBox("misc.r", "Otomatik R kullan");
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Auto Q Settings", "misc.grouplabel.addonmenu", true);
                    MainMenu.Misc.AddCheckBox("misc.q.stun", "Sabitlenmiþ Düþmana Q kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.r.stun", "Sabitlenmiþ Düþmana R Kullan", true, true);
                    ...
                    MainMenu.Misc.AddCheckBox("misc.q.taunt", "Düþmanla Alay Ederken Q Kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.r.taunt", "Düþmanla Alay Ederken R Kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.fear", "Korkmuþ Düþmana Q Kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.r.fear", "Korkmuþ Düþmana R kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.snare", "Yavaþlamýþ Düþmana Q kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.r.snare", "Yavaþlamýþ Düþmana R kullan", true, true);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Mana Yardýmcýsý:", "misc.grouplabel.addonmenu.1", true);
                    MainMenu.Misc.AddSlider("misc.q.mana", "Q için Bu Ayarlarý Manam Þunun Üstündeyse Kullan {0}%", 30, 0, 100,
                        true);
                    MainMenu.Misc.AddSlider("misc.r.mana", "R için Bu Ayarlarý Manam þunun üstündeyse Kullan {0}%", 30, 0, 100,
                        true);
