    ...
    internal class Kindred : AIOChampion
    {
        ...
        public override void Init()
        {
            ...
            try
            {
                ...
                MainMenu.Combo.AddSlider("combo.q.mode", "Komboda Q modu", 1, 1, 3, true);
                MainMenu.Combo["combo.q.mode"].Cast<Slider>().OnValueChange += ComboQMode;
                MainMenu.Combo.AddCheckBox("combo.q.inside", "W pozisyonununda oyuncuya kitlen", true, true);
                MainMenu.Combo.AddSlider("combo.w.enemy", "W menzilinde şu kadar düşman varsa kullan", 1, 1, 5, true);
                MainMenu.Combo.AddCheckBox("combo.e.focus", "E ile hedefe odaklan", true, true);
                MainMenu.Combo.AddSeparator();
                MainMenu.Combo.AddGroupLabel("Mana Yardımcısı", "combo.manamanager.label", true);
