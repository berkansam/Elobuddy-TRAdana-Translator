    ...
    internal class Twitch : AIOChampion
    {
        ...
        public override void Init()
        {
            try
            {
                ...
                MainMenu.Combo.AddSlider("combo.q.close", "Q kullan hedefi kapatacaksa", 2, 1, 5, true);
                MainMenu.Combo.AddSeparator();
                MainMenu.Combo.AddCheckBox("combo.w.multipred", "W kullan OKTR Çoklu hedef İsabet Oranı", true, true);
                MainMenu.Combo.AddSeparator();
                MainMenu.Combo.AddSlider("combo.r.aoe", "R için gerekli düşman isabet sayısı", 2, 1, 5, true);
                MainMenu.Combo.AddSeparator();
                ...
                MainMenu.Combo.AddSlider("combo.w.prediction", "W için gereken İsabet Oranı", 80, 0, 100, true);
                ...
                MainMenu.Lane.AddCheckBox("lane.execute", "E kullan Siege Minions", true, true);
                MainMenu.Lane.AddSeparator();
                MainMenu.Lane.AddSlider("lane.w.min", "W için en az minyon", 3, 1, 7, true);
                ...
                MainMenu.Misc.AddGroupLabel("Otomatik E Ayarları", "misc.grouplabel.addonmenu", true);
                MainMenu.Misc.AddCheckBox("misc.e.range", "E kullan eğer hedef menzil dışına gidiyorsa", false, true);
                MainMenu.Misc.AddSlider("misc.e.range.stacks", "Düşman için en az yük", 6, 1, 6, true);
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddCheckBox("misc.e.time", "E eğer tam yüklenmişse ve zamanlama 1 saniye altındaysa", false, true);
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddCheckBox("misc.e.death", "E kullan ölmeden önce", false, true);
                MainMenu.Misc.AddSlider("misc.e.health", "E kullanmak için canım şundan az", 10, 0, 100, true);
                MainMenu.Misc.AddSlider("misc.e.stacks", "Düşmanda en az yük", 6, 1, 6, true);
