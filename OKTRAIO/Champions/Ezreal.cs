    ...
    internal class Ezreal : AIOChampion
    {
        ...
        public override void Init()
        {
            ...
            try
            {
                ...
                MainMenu.Combo.AddGroupLabel("Combo Ayarlarý", "combo.grouplabel.mode", true);
                ...
                MainMenu.Combo["combo.rbind"].IsVisible =
                    MainMenu.Combo["combo.advanced"].Cast<CheckBox>().CurrentValue;
                MainMenu.Combo.AddSeparator();
                MainMenu.Combo.AddGroupLabel("Prediction Ayarlarý", "combo.advanced.predctionlabel", true);
                ...
                MainMenu.Combo.AddSeparator();
                MainMenu.Combo.AddGroupLabel("Mana Yardýmcýsý:", "combo.advanced.manamanagerlabel", true);
                ...
                MainMenu.Harass.AddGroupLabel("Harass Ayarlarý", "harass.grouplabel.mode", true);
                ...
                MainMenu.Harass.AddSeparator();
                MainMenu.Harass.AddGroupLabel("Prediction Ayarlarý", "harass.advanced.predctionlabel", true);
                MainMenu.Harass.AddSlider("harass.q.pred", "Q için  Ýsabet Oraný þunun üstündeyse {0}%", 45, 0, 100, true);
                MainMenu.Harass.AddSlider("harass.w.pred", "W için Ýsabet Oraný þunun üstündeyse {0}%", 30, 0, 100, true);
                MainMenu.Harass.AddSeparator();
                MainMenu.Harass.AddGroupLabel("Mana Yardýmcýsý:", "harass.advanced.manamanagerlabel", true);
                ...
                MainMenu.Lane.AddGroupLabel("Q Ayarlarý", "lane.advanced.qsettingslabel", true);
                MainMenu.Lane.AddCheckBox("lane.q.aa", "Use Q only when can't AA", true, true);
                MainMenu.Lane.AddCheckBox("lane.q.lasthit", "Son vuruþ için Q kullan bu modda", false, true);
                MainMenu.Lane.AddSeparator();
                MainMenu.Lane.AddGroupLabel("Mana Yardýmcýsý:", "harass.advanced.manamanagerlabel", true);
                ...
                MainMenu.Jungle.AddGroupLabel("Jungleclear Ayarlarý", "jungle.grouplabel.1", true);
                MainMenu.Jungle.AddCheckBox("jungle.monsters.spell", "Büyük Canavalarda Büyü Kullan", true, true);
                MainMenu.Jungle.AddCheckBox("jungle.minimonsters.spell", "Küçük Canavalarda Büyü Kullan", false, true);
                MainMenu.Jungle.AddSeparator();
                MainMenu.Jungle.AddGroupLabel("Mana Yardýmcýsý:", "jungle.grouplabel.2", true);
                ...
                MainMenu.Lasthit.AddGroupLabel("Mana Yardýmcýsý:", "lasthit.grouplabel.1", true);
                MainMenu.LasthitManaManager(true, false, false, false, 60, 50, 40, 50);

                //Ks
                MainMenu.KsKeys(defaultE: false);
                MainMenu.Ks.AddSeparator();
                MainMenu.Ks.AddGroupLabel("Mana Yardýmcýsý:", "killsteal.grouplabel.5", true);
                ...
                MainMenu.Misc.AddCheckBox("misc.w", "Otomatik W kullan");
                ...
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("Otomatik Q-W Ayarlarý", "misc.grouplabel.addonmenu", true);
                MainMenu.Misc.AddCheckBox("misc.w.ally", "Kendine ve Dostlarýna W kullan", false, true);
                MainMenu.Misc.AddCheckBox("misc.q.stun", "Sabitlenmiþ Düþmana Q kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.stun", "Sabitlenmiþ Düþmana W kullan", true, true);
                ...
                MainMenu.Misc.AddCheckBox("misc.q.taunt", "Düþmanla Alay Etmek için Q kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.taunt", "Düþmanla Alay Etmek için W kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.q.fear", "Korkmuþ Düþmana Q kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.fear", "Korkmuþ Düþmana W kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.q.snare", "Yavaþlamýþ Düþmana Q kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.snare", "Yavaþlamýþ Düþmana W kullan", true, true);
                MainMenu.Misc.AddSeparator();
                ...
                MainMenu.Misc.AddSlider("misc.q.mana", "Q için Bu Ayarlarý Manam Þunun Üstündeyse Kullan {0}%", 30, 0, 100,
                    true);
                MainMenu.Misc.AddSlider("misc.w.mana", "W için Bu Ayarlarý Manam Þunun Üstündeyse Kullan {0}%", 30, 0, 100,
                    true);
                MainMenu.DrawKeys();
                MainMenu.Draw.AddCheckBox("draw.hp.bar", "Göster Kombo Hasarý", true, true);
