        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.DrawKeys();
                    MainMenu.Draw.AddGroupLabel("W Gölge Ayarları", "draw.w.settings", true);
                    MainMenu.Draw.AddCheckBox("draw.w.q", "Göster Q", true, true);
                    MainMenu.Draw.AddCheckBox("draw.w.e", "Göster E", true, true);
                    MainMenu.Draw.AddGroupLabel("R Gölge Ayarları", "draw.r.settings", true);
                    MainMenu.Draw.AddCheckBox("draw.r.q", "Göster Q", true, true);
                    MainMenu.Draw.AddCheckBox("draw.r.e", "Göster E", true, true);
                    ...
                    MainMenu.Ks.AddSlider("killsteal.q.hitchance", "Q İsabet Oranı", 75, 1, 100, true);

                    // last hit
                    MainMenu.LastHitKeys(true, true, false, defaultE: true);
                    MainMenu.Lasthit.AddCheckBox("lasthit.notkillablebyaa",
                        "Sadece minyon AA ile öldürelemiyecekse kullan", false, true);

                    // harass
                    MainMenu.HarassKeys(useR: false);
                    MainMenu.Harass.AddCheckBox("harass.autoe", "Otomatik E", true);
                    MainMenu.Harass.AddCheckBox("harass.autoe.combodisable", "Disable When Combo", true, true);
                    MainMenu.Harass.AddCheckBox("harass.autoe.w", "W gölgesi için otomatik E", true, true);
                    MainMenu.Harass.AddCheckBox("harass.autoe.r", "R gölgesi için otomatik E", true, true);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
