    ...
    internal class Sivir : AIOChampion
    {
        ...
        public override void Init()
        {
            try
            {
                ...
                MainMenu.Combo.AddSlider("combo.r.enemy", "R için menzilde en az rakip", 3, 0, 5, true);
                MainMenu.Combo.AddSlider("combo.r.ally", "R için menzilde en az dost", 3, 0, 5, true);
                MainMenu.Combo.AddCheckBox("combo.mana.management", "Akıllı Mana Yardımcısı", true, true);
                MainMenu.Combo.AddSlider("combo.mana.health", "Canım şunun altındaysa mana yardımcısını kullanma HP % ", 30, 0,
                    100, true);

                //flee
                MainMenu.FleeKeys(false, useW: false, useE: false);
                MainMenu.Flee.AddSeparator();
                MainMenu.Flee.AddSlider("flee.r.enemy", "R menzilinde En az rakip (kaçmak için)", 2, 0, 5, true);
                MainMenu.Flee.AddSeparator();
                ...
                MainMenu.Lane.AddSlider("lane.q.min", "Q için gerekli minyon sayısı", 4, 1, 7, true);
                MainMenu.Lane.AddSlider("lane.w.min", "W için gereken minyon sayısı", 3, 1, 7, true);
                MainMenu.Lane.AddSeparator();
                MainMenu.Lane.AddCheckBox("lane.q.harass", "Dürtmede Q kullan", true, true);
                MainMenu.Lane.AddCheckBox("lane.w.turret", "W kullan Kule/İnhibitör/Nexus", true, true);
                MainMenu.Lane.AddSeparator();
                ...
                //misc
                MainMenu.MiscMenu();
                MainMenu.Misc.AddGroupLabel("Otomatik E - Büyü Ayarları", "misc.grouplabel.addonmenu");
                ...
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("Otomatik Q Ayarları", "misc.grouplabel.addonmenu.1", true);
                ...
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("İsabet Oranı", "misc.grouplabel.addonmenu.2", true);
                ...
                MainMenu.Misc.AddSlider("misc.q.mana", "Q için Bu Ayarları Manam Şunun Üstündeyse Kullan {0}%", 30, 0, 100,
                    true);
