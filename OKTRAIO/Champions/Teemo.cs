    ...
    internal class Teemo : AIOChampion
    {
        ...
        public override void Init()
        {
            try
            {
                ...
                MainMenu.Combo.AddGroupLabel("Sadece Q kullan:", "combo.grouplabe2.addonmenu");
                ...
                MainMenu.Combo.AddSlider("combo.w.distance", "Düşman menzildeyse W kullan", 600, 1, 1200,
                    true);
                MainMenu.Combo.AddSlider("combo.r.stacks", "Ultide şu kadar yük tut", 1, 0, 3, true);

                //flee
                MainMenu.FleeKeys(useE: false);
                MainMenu.Flee.AddSeparator();
                MainMenu.Flee.AddSlider("flee.r.stacks", "Ultide şu kadar yük tut", 1, 0, 3, true);
                ...
                MainMenu.Lane.AddSlider("lane.r.min", "R için en az minyon sayısı", 3, 1, 7, true);
                MainMenu.Lane.AddSlider("lane.r.stacks", "Ultide şu kadar yük tut", 1, 0, 3, true);
                MainMenu.Lane.AddGroupLabel("Mana Yardımcısı:", "lane.grouplabel.addonmenu", true);
                ...
                MainMenu.Jungle.AddSlider("jungle.r.min", "R için gerekli minyon sayısı", 3, 1, 4, true);
                MainMenu.Jungle.AddSlider("jungle.r.stacks", "Ultide şu kadar yük tut", 1, 0, 3, true);
                ...
                MainMenu.Misc.Add("misc.r.auto",
                    new KeyBind("Otomatik Mantar Yerleri", true, KeyBind.BindTypes.PressToggle, 'G'));
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddSlider("misc.r.stacks", "Ultide şu kadar yük tut", 1, 0, 3);
                MainMenu.Misc.AddSlider("misc.r.mana", "Otomatik Mantar kullan eğer manam şundan çoksa", 30);
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddCheckBox("misc.q.gapcloser", "gapcloser Q kullan ");
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("Otomatik Q/R Ayarları", "misc.grouplabel1.addonmenu", true);
                MainMenu.Misc.AddSeparator();
                ...
                MainMenu.Misc.AddCheckBox("misc.q.knockup", "Q ile düşmana vurmak", true, true);
                MainMenu.Misc.AddCheckBox("misc.q.snare", "Yavaşlamış Düşmana Q kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.q.suppression", "Q ile düşmanı önlemek", true, true);
                ...
                MainMenu.Misc.AddCheckBox("misc.r.stun", "Sabitlenmiş Düşmana R kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.r.knockup", "R ile düşmana vurmak", true, true);
                MainMenu.Misc.AddCheckBox("misc.r.snare", "Yavaşlamış Düşmana R kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.r.suppression", "Düşmanı önlemek için R kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.r.taunt", "Düşmanla Alay Etmek için R kullan", true, true);
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("İsabet Oranı", "combo.grouplabel2.addonmenu", true);
                MainMenu.Misc.AddSlider("misc.r.prediction", "R için İsabet Oranı", 80, 0, 100, true);
                MainMenu.Misc.AddSlider("misc.r.delay", "Mantar Bırakma Gecikmesi", 1500, 1000, 4000, true);
                ...
                MainMenu.Draw.AddCheckBox("draw.r.auto", "Göster Otomatik Mantar Yerleri", true, true);
                MainMenu.Draw.AddCheckBox("draw.status", "Göster Otomatik Mantar Durumu", true, true);
            }
