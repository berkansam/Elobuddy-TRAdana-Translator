...
namespace OKTRAIO.Champions
{
    internal class Lucian : AIOChampion
    {
        ...
        public override void Init()
        {
            ...
            MainMenu.Combo.AddGroupLabel("Kombo Ayarları", "combo.gl.pref", true);
            MainMenu.Combo.Add("combo.mode", new Slider("Combo Modu", 0, 0, 1)).OnValueChange += ModeSlider;
            ...
            MainMenu.Combo.Add("combo.speed", new Slider("Combo Hızı", 0, 0, 2)).OnValueChange += SpeedSlider;
            ...
            MainMenu.Combo.AddCheckBox("combo.eq", "Gelişmiş Q eğer kombo modu = Normalse", true, true);
            MainMenu.Combo.AddCheckBox("combo.wcol", "Çarpışmada w kontrol et", false, true);
            MainMenu.Combo.AddCheckBox("combo.egap", "Gapclose E Kullan  (Önerilmez)", false, true);
            MainMenu.Combo.AddSeparator();
            ...
            MainMenu.Combo.Add("combo.rbind",
                new KeyBind("Yarı otomatik R (Kilitlenmez)", false, KeyBind.BindTypes.HoldActive, 'T'))
            ...
            MainMenu.Harass.AddGroupLabel("Dürtme Ayarları", "harass.gl.pref", true);
            MainMenu.Harass.AddCheckBox("harass.eq", "Dürterken Gelişmiş Q kullan", true, true);
            MainMenu.Harass.AddCheckBox("harass.wcol", "Çarpışmada W kontrol et", false, true);
            ...
            MainMenu.Harass.AddSlider("harass.mana", "Mana yardımcısı:", 60, 0, 100, true);

            MainMenu.JungleKeys(useR: false);
            MainMenu.Jungle.AddSlider("jungle.mana", "Mana yardımcısı:", 80, 0, 100, true);

            MainMenu.LaneKeys(useR: false);
            MainMenu.Lane.AddGroupLabel("LaneClear Ayarları", "lane.gl.pref", true);
            MainMenu.Lane.AddCheckBox("lane.qharass", "Q = Dürt Düşmanları", false, true);
            MainMenu.Lane.AddSeparator();
            MainMenu.Lane.AddSlider("lane.minfarm", "Q ile farm için en az minyon", 3, 0, 6, true);
            MainMenu.Lane.AddSlider("lane.mana", "Mana Yardımcısı:", 80, 0, 100, true);

            MainMenu.KsKeys(useW: false);

            MainMenu.DrawKeys(useW: false, useE: false);
            MainMenu.Draw.AddSeparator();
            MainMenu.Draw.AddLabel("W/Gelişmiş Q Ayarları");
            MainMenu.Draw.Add("draw.qw", new CheckBox("Göster W/Gelişmiş Q"));
