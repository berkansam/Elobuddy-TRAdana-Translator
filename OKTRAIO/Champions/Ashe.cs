    ...
    internal class Ashe : AIOChampion
    {
        ...
        public override void Init()
        {
            try
            {
                ...
                MainMenu.Combo.AddGroupLabel("Kombo Ayarları", "combo.grouplabel.addonmenu", true);
                MainMenu.Combo.Add("combo.rbind",
                    new KeyBind("Yarı Otomatik R (Kilitleme)", false, KeyBind.BindTypes.HoldActive, 'T'))
                    .OnValueChange += OnUltButton;
                MainMenu.Combo.AddCheckBox("combo.r.aoe", "R kullan için AOE", true, true);
                MainMenu.Combo.AddSlider("combo.r.slider", "{0} R için gereken düşman", 3, 0, 5, true);
                MainMenu.Combo.AddSeparator();
                MainMenu.Combo.AddGroupLabel("İsabet", "combo.grouplabel1.addonmenu", true);
                MainMenu.Combo.AddSlider("combo.wr.prediction", "W/R için isabet oranı %", 80, 0, 100, true);
                ...
                MainMenu.Lane.AddSlider("lane.w.min", "W için gereken minyon", 3, 1, 7, true);
                ...
                MainMenu.Misc.AddCheckBox("misc.r.interrupter", "Ryi kullan Interrupt");
                MainMenu.Misc.AddCheckBox("misc.w.gapcloser", "W Kullan Anti-Gapcloser");
                MainMenu.Misc.AddCheckBox("misc.r.auto", "Anti Rengar + Khazix");
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("Otomatik W Ayarları", "misc.grouplabel1.addonmenu", true);
                MainMenu.Misc.AddCheckBox("misc.w.charm", "Use W on Charmed Enemy", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.stun", "Stun yiyen düşmanda W Kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.knockup", "W Kullan Düşmana çarpası için", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.snare", "W kullan düşmanı yavaşlatmak için", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.suppression", "Düşmanı önlemek için W kullan", true, true);
                MainMenu.Misc.AddCheckBox("misc.w.taunt", "Düşmanla Alay Etmek İçin W kullan", true, true);
                MainMenu.Misc.AddSeparator();
                MainMenu.Misc.AddGroupLabel("Mana Yardımcısı", "misc.grouplabel.mana", true);
                MainMenu.Misc.AddSlider("misc.w.mana", "Topluluğu kontrol et düşmanın manası şundan çoksa w kullan {0}%", 30, 0, 100,
                        true);
