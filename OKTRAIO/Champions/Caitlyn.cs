        ...
        public override void Init()
        {
            try
            {
                ...
                try
                {
                    ...
                    MainMenu.Combo.AddGroupLabel("Combo Özellikleri", "combo.grouplabel.1", true);
                    MainMenu.Combo.AddCheckBox("combo.melee", "Yetenekleri kullan düz vuruş menzilinde", false, true);
                    MainMenu.Combo.AddCheckBox("combo.force.target", "Hedefi Pasifle zorla ", true, true);
                    MainMenu.Combo.AddCheckBox("combo.e.gapcloser", "E kullanarak Hedefe Yetiş", false, true);
                    MainMenu.Combo.AddSlider("combo.e.range",
                        "Hedef Menzildeyse E kullanma ve e için gerekli{0} düşman", 1, 1, 5, true);
                    MainMenu.Combo.Add("combo.e.q.bind",
                        new KeyBind("Kullan E + Q Büyüsü", false, KeyBind.BindTypes.HoldActive, 'Z'))
                    ...
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("İsabet Ayarları", "combo.grouplabel.2", true);
                    MainMenu.Combo.AddSlider("combo.q.prediction", "İsabet Oranı Q için > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddSlider("combo.w.prediction", "İsabet Oranı W için > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddSlider("combo.e.prediction", "İsabet Oranı E için > {0}%", 80, 0, 100, true);
                    MainMenu.Combo.AddSeparator();
                    MainMenu.Combo.AddGroupLabel("Mana Yardımcısı:", "combo.grouplabel.3", true);
                    ...
                    MainMenu.Lane.AddGroupLabel("LaneClear Ayarları", "lane.grouplabel.1", true);
                    MainMenu.Lane.AddSlider("lane.farm", "Q kullan şundan fazla minyonda {0} ", 3, 0, 6, true);
                    MainMenu.Lane.AddSeparator();
                    MainMenu.Lane.AddGroupLabel("Mana Yardımcısı:", "lane.grouplabel.2", true);
                    ...
                    MainMenu.Jungle.AddCheckBox("jungle.monsters.spell", "Büyük canavarlarda yetenek kullan", true, true);
                    MainMenu.Jungle.AddCheckBox("jungle.minimonsters.spell", "Küçük canavarlarda yetenek kullan", false,
                        true);
                    MainMenu.Jungle.AddSeparator();
                    MainMenu.Jungle.AddGroupLabel("Mana Yardımcısı:", "jungle.grouplabel.1", true);
                    ...
                    MainMenu.Lasthit.AddGroupLabel("Mana Yardımcısı:", "lasthit.grouplabel.1", true);
                    MainMenu.LasthitManaManager(true, false, true, false, 40, 0, 60, 0);

                    //Harras
                    MainMenu.HarassKeys(useR: false);
                    MainMenu.Harass.AddSeparator();
                    MainMenu.Harass.AddGroupLabel("Dürtme Ayarları:", "harass.grouplabel.1", true);
                    MainMenu.Harass.AddCheckBox("harass.auto", "Otomatik Dürtme", false, true);
                    MainMenu.Harass.AddSlider("harass.traps", "Tuzak Limiti", 2, 1, 5, true);
                    MainMenu.Harass.AddCheckBox("harass.force.target", "Pasifle Hedefi Zorla", true, true);
                    MainMenu.Harass.AddSeparator();
                    MainMenu.Harass.AddGroupLabel("Prediction Settings", "harass.grouplabel.2", true);
                    MainMenu.Harass.AddSlider("harass.q.prediction", "Q için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Harass.AddSlider("harass.w.prediction", "W için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Harass.AddSlider("harass.e.prediction", "E için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Harass.AddSeparator();
                    MainMenu.Harass.AddGroupLabel("Mana Yardımcısı:", "harass.grouplabel.3", true);
                    MainMenu.HarassManaManager(true, true, true, false, 50, 50, 50, 0);

                    //Flee Menu
                    MainMenu.FleeKeys(false, useR: false);
                    MainMenu.Flee.AddSeparator();
                    MainMenu.Flee.AddGroupLabel("Mana Yardımcısı:", "flee.grouplabel.1", true);
                    MainMenu.FleeManaManager(false, true, true, false, 0, 10, 20, 0);

                    //Ks
                    MainMenu.KsKeys();
                    MainMenu.Ks.AddSeparator();
                    MainMenu.Ks.AddGroupLabel("Kill Çalma Ayarları: ", "killsteal.groulabel.1", true);
                    MainMenu.Ks.AddCheckBox("killsteal.spells.flee", "Kaçarken Kill Çalmayı Önle",
                        false, true);
                    ...
                    MainMenu.Ks.AddSlider("killsteal.r.safe", "Use R only if the target leaves {0} range", 1500, 800,
                        3000, true);
                    MainMenu.Ks.AddSeparator();
                    MainMenu.Ks.AddGroupLabel("İsabet Oranı Ayarları", "killsteal.grouplabel.2", true);
                    MainMenu.Ks.AddSlider("killsteal.q.prediction", "Q için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Ks.AddSlider("killsteal.w.prediction", "W için İsabet Oranıe > {0}%", 80, 0, 100, true);
                    MainMenu.Ks.AddSlider("killsteal.e.prediction", "E için İsabet Oranı > {0}%", 80, 0, 100, true);
                    MainMenu.Ks.AddGroupLabel("Mana Yardımcısı:", "killsteal.grouplabel.3", true);
                    MainMenu.KsManaManager(true, true, true, false, 10, 10, 20, 0);

                    //Misc Menu
                    MainMenu.MiscMenu();
                    MainMenu.Misc.AddCheckBox("misc.q", "Q Kullan");
                    MainMenu.Misc.AddCheckBox("misc.w", "W Kullan");
                    MainMenu.Misc.AddCheckBox("misc.e", "Otomatik E Kullan", false);
                    MainMenu.Misc.AddCheckBox("misc.w.gapcloser", "Otomatik W Kullan Gapcloser", true, true);
                    MainMenu.Misc.AddCheckBox("misc.e.gapcloser", "Otomatik E Kullan Gapcloser", true, true);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Otomatik Büyü Ayarları", "misc.grouplabel.1", true);
                    MainMenu.Misc.AddCheckBox("misc.q.stun", "Sabit Düşmana Q kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.w.stun", "Sabit Düşmana W kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.e.stun", "Sabit Düşmana E Kullan", true, true);
                    ...
                    MainMenu.Misc.AddCheckBox("misc.q.taunt", "Düşmanla Alay Ederken Q Kullan ", true, true);
                    MainMenu.Misc.AddCheckBox("misc.w.taunt", "Düşmanla Alay Ederken W kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.e.taunt", "Düşmanla Alay Ederken E kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.fear", "Korkmuş Düşmana Q Kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.w.fear", "Korkmuş Düşmana W kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.e.fear", "Korkmuş Düşmana E kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.q.snare", "Yavaşlamış Düşmana Q Kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.w.snare", "Yavaşlamış Düşmana W Kullan", true, true);
                    MainMenu.Misc.AddCheckBox("misc.e.snare", "Yavaşlamış Düşmana E Kullan", true, true);
                    MainMenu.Misc.AddSlider("misc.traps", "Tuzak Limiti", 2, 1, 5, true);
                    MainMenu.Misc.AddSeparator();
                    MainMenu.Misc.AddGroupLabel("Mana Yardımcısı:", "misc.grouplabel.2", true);
                    MainMenu.Misc.AddSlider("misc.q.mana", "Toplu Saldırıda Manam şundan yüksekse Q kullan %", 30, 0, 100,
                        true);
                    MainMenu.Misc.AddSlider("misc.w.mana", "Toplu Saldırıda manam şundan yüksekse w kullan {0}%", 30, 0, 100,
                        true);
                    MainMenu.Misc.AddSlider("misc.e.mana", "toplu saldırıda manam şundna yüksekse e kullan {0}%", 30, 0, 100,
                        true);
