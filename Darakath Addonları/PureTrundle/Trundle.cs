namespace PureTrundle
{
    ...
    internal class Trundle
    {
        ...
        public static void CreateMenu()
        {
            ...
            Menu.AddGroupLabel("PureTrundle Darakath Tarafından");
            Menu.AddGroupLabel("Ceviri-TRAdana iyi oyunlar diler");

            CMenu = Menu.AddSubMenu("Kombo", "cMenu");
            CMenu.Add("W", new CheckBox("Kullan W"));
            CMenu.AddSeparator();
            CMenu.Add("E", new CheckBox("Kullan E"));
            CMenu.AddSeparator();
            CMenu.Add("R", new CheckBox("Kullan R"));
            CMenu.AddSeparator();
            CMenu.Add("BC", new CheckBox("Kullan MahvolmuşKılıç"));
            CMenu.AddSeparator();
            CMenu.Add("TH", new CheckBox("Kullan Tiamat/Hydra"));

            HMenu = Menu.AddSubMenu("Dürtme", "hMenu");
            HMenu.Add("W", new CheckBox("Kullan W"));
            HMenu.AddSeparator();
            HMenu.Add("E", new CheckBox("Kullan E"));
            HMenu.AddSeparator();
            HMenu.Add("TH", new CheckBox("Kullan Tiamat/Hydra"));

            WMenu = Menu.AddSubMenu("Lane/Jungle Clear", "wMenu");
            WMenu.Add("QW", new CheckBox("LaneTemizlemede Q Kullan", false));
            WMenu.AddSeparator();
            WMenu.Add("QJ", new CheckBox("Orman Temizlemede Q kullan", false));
            WMenu.AddSeparator();
            WMenu.Add("WW", new CheckBox("Lane Temizlemede W kullan", false));
            WMenu.AddSeparator();
            WMenu.Add("WJ", new CheckBox("Orman Temizlemede W kullan", false));
            WMenu.AddSeparator();
            WMenu.Add("TH", new CheckBox("Kullan Tiamat/Hydra"));

            MMenu = Menu.AddSubMenu("Mana", "mMenu");
            MMenu.Add("Q", new Slider("Q için Mana"));
            MMenu.Add("W", new Slider("W için Mana"));
            MMenu.Add("E", new Slider("E için Mana"));
            MMenu.Add("R", new Slider("R için Mana"));
            Menu.AddSeparator();
            MMenu.Add("WC", new Slider("LaneTemizleme İçin Mana Kullan"));
            MMenu.Add("JF", new Slider("OrmanTemizleme için Mana Kullan"));
            MMenu.Add("H", new Slider("Dürtmek için Mana Kullan"));

            DMenu = Menu.AddSubMenu("Göstergeler", "dMenu");
            DMenu.Add("W", new CheckBox("Göster W Menzili", false));
            DMenu.Add("E", new CheckBox("Göster E Menzili", false));
            DMenu.Add("R", new CheckBox("Göster R Menzili"));
            DMenu.Add("RD", new CheckBox("HP Bar Indicator (Q+R+AA+Items)"));

            OMenu = Menu.AddSubMenu("Diğer", "oMenu");
            OMenu.Add("GC", new CheckBox("Otomatik Anti-GapCloser", false));
        }
