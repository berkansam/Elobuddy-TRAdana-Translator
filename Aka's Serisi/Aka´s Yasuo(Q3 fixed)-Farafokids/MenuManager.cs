...
namespace AkaYasuo
{
    internal class MenuManager
    {
        ...
        public static void Harassmenu()
        {
            ...
            HarassMenu.Add("QLastHit", new CheckBox("Q Sonvuruş?"));
        }
        ...
        public static void Miscmenu()
        {
            ...
            MiscMenu.Add("skinhack", new CheckBox("Activate Skin Hilesi"));
            MiscMenu.Add("skinId", new ComboBox("Skin Hilesi", 0, "Default", "High Noon Yasuo" , "Project Yasuo", "Blood Moon Yasuo"));
        }
