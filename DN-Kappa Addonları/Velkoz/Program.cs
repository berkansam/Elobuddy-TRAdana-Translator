...
namespace Velkoz
{
    ...
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menuIni.AddGroupLabel("Worstun vel koz addonuna hoşgeldiniz!");
            ...
            menuIni.Add("Clear", new CheckBox("Kullan LaneTemizleme?"));
            ...
            ComboMenu.Add("Ignite", new CheckBox("Tutuştur"));
            ComboMenu.Add("Rhit", new Slider("R çarpacak düşman sayısı", 2, 1, 5));
            ...
            MiscMenu.Add("gapclosermana", new Slider("mana şundan azsa kullanma %", 25, 0, 100));
