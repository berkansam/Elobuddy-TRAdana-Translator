...
namespace LittleHumanizer
{
    public static class Program
    {
        ...
        {
            Chat.Print("LittleHumanizer Loaded! By Support - Çeviri TRAdana kullandığınız için teşekkürler");
            _menu = MainMenu.AddMenu("Biraz İnsancıl", "LittleHumanizer");
            _menu.AddGroupLabel("LittleHumanizer");
            _menu.AddLabel("'I'm a Sharp Human Pro' Bansharp scriptinin portlamasıdır.");
            _setting = _menu.AddSubMenu("Ayarlar", "settings");
            _setting.AddGroupLabel("Ayarlar");
            _setting.AddLabel("Gecikme");
            _setting.Add("Spells", new CheckBox("İnsancıl Büyü"));
            _setting.Add("Attacks", new CheckBox("İnsancıl Saldırı"));
            _setting.Add("Movements", new CheckBox("İnsancıl Yürüyüş"));
            _setting.Add("MinClicks", new Slider("Saniyedeki en az tıklama", _random.Next(6, 7), 1, 7));
            _setting.Add("MaxClicks",
                new Slider("Saniyedeki en fazla tıklama",
        ...
        {
            Chat.Print("<font color='#ff0000'>LittleHumanizer Yüklenemedi!</font>");
            _menu = MainMenu.AddMenu("LittleHumanizer(Disabled)", "LittleHumanizer(Disabled)", "LittleHumanizer(Disabled)");
            _menu.AddLabel("Little Humanizer Yüklenemedi. Lütfen Güncelleme Bekleyiniz");
        }
