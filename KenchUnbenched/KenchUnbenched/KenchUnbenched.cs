...
namespace KenchUnbenched
{
    static class KenchUnbenched
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            ComboMenu.Add("Combo.QOnlyStun", new CheckBox("Kullan Q Sadece sabitlemek için / AA dışında"));
            ComboMenu.Add("Combo.W.Enemy", new CheckBox("W kullan düşmana"));
            ComboMenu.Add("Combo.W.Minion", new CheckBox("W ile minyon fırlat"));
            ComboMenu.Add("Combo.E", new CheckBox("E Kullan"));

            HarassMenu = Menu.AddSubMenu("Harass Menu", "harassmenuKench");
            HarassMenu.AddGroupLabel("Harass Ayarları");
            HarassMenu.Add("Harass.Q", new CheckBox("Kullan Q"));
            HarassMenu.Add("Harass.W.Enemy", new CheckBox("W ile düşmana"));
            ...
            FarmingMenu.AddLabel("LastHit Ayarları");
            FarmingMenu.Add("LastHit.Q", new CheckBox("Kullan Q"));
            FarmingMenu.AddLabel("WaveClear Ayarları");
            FarmingMenu.Add("WaveClear.Q", new CheckBox("Kullan Q"));
            FarmingMenu.AddLabel("Jungle Ayarları");
            FarmingMenu.Add("Jungle.Q", new CheckBox("Kullan Q"));

            KenchSaver.Initialize();

            KillStealMenu = Menu.AddSubMenu("KillSteal Menu");
            KillStealMenu.AddGroupLabel("KillSteal Ayarları");
            KillStealMenu.Add("KillSteal.Q", new CheckBox("Kullan Q"));
            KillStealMenu.Add("KillSteal.W.Swallow", new CheckBox("W Kullan"));
            KillStealMenu.Add("KillSteal.W.Spit", new CheckBox("W Kullan"));
