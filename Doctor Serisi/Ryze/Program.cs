...
namespace Ryze
{
    class Program
    {
        ...
        public static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            SubMenu["Combo"].AddLabel("WQER 1 Stack sonra ULT or 2 Stack sonra ULT or 3 Stacks sonra ULT  Veya 3 Stacks Kullanma ULT");
            SubMenu["Combo"].AddSeparator();
            SubMenu["Combo"].AddLabel("QEWR 2 Stacks Combo Sadece Ulti Hazırsa");
            SubMenu["Combo"].AddSeparator();
            SubMenu["Combo"].AddLabel("QEW 2 Stacks Combo Sadece Ulti yoksa");
            SubMenu["Combo"].AddSeparator();
            SubMenu["Combo"].AddLabel("QEQ 3 Stacks İle Level 6ya kadar");
            SubMenu["Combo"].AddSeparator();
            SubMenu["Combo"].AddLabel("WQRE 3 Stacks İle sadece ulti hazırsa(Double-Snare combo)");
            SubMenu["Combo"].AddSeparator();
            ...
            var mode = SubMenu["Combo"].Add("Mode", new Slider("Combo Tipi", 0, 0, 4));
            var modeDisplay = new[] { "WQER 1-2-3 Stacks", "QEWR 2 Stacks", "QEW 2 Stacks(ULT yok)", "QEQ 3 Stacks", "WQRE 3 Stacks" };
            ...
            var switcher = SubMenu["Combo"].Add("Switcher", new KeyBind("Combo Değiştirme Tuşu", false, KeyBind.BindTypes.HoldActive, (uint)'K'));
            ...
            SubMenu["Harass"].Add("W", new CheckBox("Kullan W", true));
            SubMenu["Harass"].Add("E", new CheckBox("Kullan E", true));
            SubMenu["Harass"].Add("HarassMana", new Slider("Mana Yüzdesi", 50, 0, 100));

            SubMenu["LastHit"] = menu.AddSubMenu("SonVuruş", "LastHit");
            SubMenu["LastHit"].Add("Q", new CheckBox("Kullan Q", true));
            SubMenu["LastHit"].Add("W", new CheckBox("Kullan W", true));
            SubMenu["LastHit"].Add("E", new CheckBox("Kullan E", true));
            SubMenu["LastHit"].Add("LastHitMana", new Slider("Mana Yüzdesi", 50, 0, 100));

            SubMenu["LaneClear"] = menu.AddSubMenu("LaneTemizleme", "LaneClear");
            SubMenu["LaneClear"].Add("LC", new KeyBind("LaneTemizleme Tuşu", false, KeyBind.BindTypes.HoldActive, 'X'));
            SubMenu["LaneClear"].Add("Q", new CheckBox("Kullan Q", true));
            SubMenu["LaneClear"].Add("W", new CheckBox("Kullan W", true));
            SubMenu["LaneClear"].Add("E", new CheckBox("Kullan E", true));
            SubMenu["LaneClear"].Add("R", new CheckBox("Kullan R", true));
            SubMenu["LaneClear"].Add("LaneClearMana", new Slider("Mana Yüzdesi", 50, 0, 100));

            SubMenu["JungleClear"] = menu.AddSubMenu("OrmanTemizleme", "JungleClear");
            SubMenu["JungleClear"].Add("JC", new KeyBind("OrmanTemizleme Tuşu", false, KeyBind.BindTypes.HoldActive, 'X'));
            ...
            SubMenu["JungleClear"].Add("R", new CheckBox("Kullan R", true));
            SubMenu["JungleClear"].Add("JungleClearMana", new Slider("Mana Yüzdesi", 50, 0, 100));

            SubMenu["Misc"] = menu.AddSubMenu("Misc", "Misc");


            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Kill Çalma Ayarları");
            SubMenu["Misc"].Add("KsQ", new CheckBox("Kullan Q", true));
            SubMenu["Misc"].Add("KsW", new CheckBox("Kullan W", true));
            SubMenu["Misc"].Add("KsE", new CheckBox("Kullan E", true));

            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Interrupt/AntiGapcloser Ayarları");
            SubMenu["Misc"].Add("Interrupt", new CheckBox("Interrupt/AntiGapcloser W ile kullan", true));

            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Seraph Ayarları");
            SubMenu["Misc"].Add("seraph", new CheckBox("Seraph kullan", true));
            SubMenu["Misc"].Add("seraphHp", new Slider("benim canım şundan az <=", 50, 0, 101));
            SubMenu["Misc"].Add("seraphCount", new Slider("ve şu kadar düşman menzilde >=", 2, 0, 5));

            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Zhonyas Ayarları");
            SubMenu["Misc"].Add("zhonyas", new CheckBox("Kullan Zhonyas", true));
            SubMenu["Misc"].Add("zhonyasHp", new Slider("Canım şundan az <=", 50, 0, 101));
            SubMenu["Misc"].Add("zhonyasCount", new Slider("ve şu kadar düşman menzilde >=", 2, 0, 5));

            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Skin Ayarları");
            ...
            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Göstergeler");
            SubMenu["Misc"].Add("DrawQ", new CheckBox("Göster Q", true));
            SubMenu["Misc"].Add("DrawW", new CheckBox("Göster W", true));
            SubMenu["Misc"].Add("DrawE", new CheckBox("Göster E", true));
