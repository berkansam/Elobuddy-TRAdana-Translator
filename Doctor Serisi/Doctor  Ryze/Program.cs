...
namespace Ryze
{
    class Program
    {
        ...
        public static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            menu.AddLabel("Tesekkurler!");

            SubMenu["Combo"] = menu.AddSubMenu("Combo", "Combo");
            SubMenu["Combo"].AddLabel("WQER 1 stack ulti veya 2 Stack ULT veya 3 Stacks ULT  veya 3 Stacks Ultisiz");
            SubMenu["Combo"].AddSeparator();
            SubMenu["Combo"].AddLabel("QEWR Sadece ulti varsa 2 stackla kombo yap");
            SubMenu["Combo"].AddSeparator();
            SubMenu["Combo"].AddLabel("QEW Ulti Yokken 2 Stackle kombo yapma");
            SubMenu["Combo"].AddSeparator();
            ...
            SubMenu["LaneClear"].Add("LC", new KeyBind("Lanetemizleme Tuşu", false, KeyBind.BindTypes.HoldActive, 'V'));
            ...
            SubMenu["JungleClear"].Add("JC", new KeyBind("Ormantemizleme Tuşu", false, KeyBind.BindTypes.HoldActive, 'V'));
            ...
            SubMenu["Misc"].Add("Interrupt", new CheckBox("Interrupt/AntiGapcloser W Kullan", true));

            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Seraph Ayarları");
            SubMenu["Misc"].Add("seraph", new CheckBox("Seraph Kullan", true));
            SubMenu["Misc"].Add("seraphHp", new Slider("Benim canım şundna az <=", 50, 0, 101));
            SubMenu["Misc"].Add("seraphCount", new Slider("Ve menzilde şu kadar düşman varken >=", 2, 0, 5));

            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Zhonyas Ayarları");
            SubMenu["Misc"].Add("zhonyas", new CheckBox("zhonya kullan", true));
            SubMenu["Misc"].Add("zhonyasHp", new Slider("Benim canım şu kadarken <=", 50, 0, 101));
            SubMenu["Misc"].Add("zhonyasCount", new Slider("ve menzilde şu kadar düşman >=", 2, 0, 5));
            ...
            SubMenu["Misc"].AddSeparator(10);
            SubMenu["Misc"].AddGroupLabel("Göster Ayarları");
