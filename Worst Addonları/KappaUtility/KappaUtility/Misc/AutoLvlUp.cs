namespace KappaUtility.Misc
{
    ...
    internal class AutoLvlUp
    {
        ...
        internal static void OnLoad()
        {
            ...
            LevelMenu.AddGroupLabel("otomatik level ayarlama");
            LevelMenu.Add(Player.Instance.ChampionName + "enable", new CheckBox("Aktif", false));
            LevelMenu.AddSeparator();
            LevelMenu.AddGroupLabel("Level Ayarı");
            ...
            LevelMenu.AddSeparator();
            LevelMenu.AddGroupLabel("İnsancıl ayar(ellemeyin)");
            LevelMenu.Add("min", new Slider("En az gecikme süresi", 1000, 0, 2500));
            LevelMenu.Add("max", new Slider("En fazla gecikme süresi", 2501, 2501, 5000));
